<% SendWebHeadStr();%>
<title>IPv6 ACL <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
<p class="intro_title">IPv6 ACL <% multilang("245" "LANG_CONFIGURATION"); %></p>
<p class="intro_content"> <% multilang("567" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_IPV6_ADDRESS_FOR_ACCESS_CONTROL_LIST_IF_ACL_IS_ENABLED_ONLY_THE_IP_ADDRESS_IN_THE_ACL_TABLE_CAN_ACCESS_CPE_HERE_YOU_CAN_ADD_DELETE_THE_IP_ADDRESS"); %></p>
</div>
<form action=/boaform/admin/formV6ACL method=POST name="acl">
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%">IPv6 ACL <% multilang("568" "LANG_CAPABILITY"); %>:</th>
   <td>
    <input type="radio" value="0" name="aclcap" <% checkWrite("v6-acl-cap0"); %>><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="aclcap" <% checkWrite("v6-acl-cap1"); %>><% multilang("255" "LANG_ENABLE"); %>
   </td>
   <td><input class="inner_btn" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="apply" onClick="return on_submit(this)">&nbsp;&nbsp; </td>
  </tr>
 </table>
</div>
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th width="30%"><% multilang("397" "LANG_SOURCE"); %> <% multilang("2005" "LANG_TIP_ADDR"); %>:</th>
   <td><input type="text" size="16" name="sip6Start"></td>
  </tr>
  <tr>
   <th width="30%"><% multilang("397" "LANG_SOURCE"); %> <% multilang("472" "LANG_PREFIX_LENGTH"); %>:</th>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="addIP" onClick="return addClick(this)">
</div>
<div class="column">
