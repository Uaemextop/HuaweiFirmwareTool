...
function saveClick()
{
 ...
 if ( document.addressMap.addressMapType.selectedIndex == 0 ) {
   ...
   alert('<% multilang("2078" "LANG_LOCAL_START_IP_DOMAIN_IS_DIFFERENT_FROM_LOCAL_END_IP"); %>');
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("642" "LANG_ADDRESS_MAPPING_RULE"); %></p>
 <p class="intro_content"> <% multilang("643" "LANG_THIS_PAGE_IS_USED_TO_SET_AND_CONFIGURE_THE_ADDRESS_MAPPING_RULE_FOR_YOUR_DEVICE"); %></p>
</div>
