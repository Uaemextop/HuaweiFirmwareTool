...
function ginp_saveChanges(obj)
{
 if(document.set_vtuo_ginp.DSGinpMode.selectedIndex!=0)
 {
  ...
  {
   alert('<% multilang("2096" "LANG_INVALID_VALUE_FOR_EFFECTIVE_THROUGHPUT"); %>');
