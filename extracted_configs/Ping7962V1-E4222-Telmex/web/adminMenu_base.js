					...
					items: [
						...
						,
						{
							...
							href: pageRoot + 'boaform/formWlanRedirect?redirect-url=/wlstatus.asp&wlan_idx=2'
                                                ...
                                                {
                                                        name: '<% multilang(LANG_GUEST_WIFI); %>',
                                                        href: pageRoot + 'boaform/formWlanRedirect?redirect-url=/guest_wifi.asp&wlan_idx=2'
                                                }
					]
				}
...
#ifdef RTK_MULTI_AP_VERION_1_3F
						href: pageRoot + 'multi_ap_setting_general_1_3F.asp'
#else
...
#if defined(CONFIG_GPON_FEATURE) || defined(CONFIG_EPON_FEATURE)
					{
						name: '<% getWanIfDisplay(); %><% multilang(LANG_WAN); %>',
