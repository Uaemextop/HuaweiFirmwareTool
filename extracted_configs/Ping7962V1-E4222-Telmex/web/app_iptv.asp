<%SendWebHeadStr(); %>
<title>Mcast-VLAN <% multilang("2751" "LANG_MCAST_VLAN"); %></title>
<script>
var links = new Array();
<% listWanName(); %>
var index =-1;
...
{
 var str=new Array();
 str[1]=new Array(102, '<% multilang("2754" "LANG_INPUT_INTEGER"); %>');
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("2751" "LANG_MCAST_VLAN"); %></p>
</div>
<form id="mcast_vmap" action=/boaform/admin/formMcastVlanMapping method=POST name=mcast_vmap>
<div class="data_common data_common_notitle">
 <table id="mcast_table">
  <tr>
   <th id="Fnt_mcast_vlanA"><% multilang("2752" "LANG_MCAST_VLAN_SETUP"); %></th>
   <td><input name="Frm_mcast_vlan" id="Frm_mcast_vlan" type="text" class="inputId" disabled="true" value="" size="15" /></td>
  </tr>
 </table>
</div>
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("341" "LANG_APPLY"); %>" id="modify" style="display:none" onclick="return ModifyApply();" />
 <input class="link_bg" name="back" type="button" id="back" value="<% multilang("343" "LANG_UNDO"); %>" onclick="back2add()" style="display:none"/>
</div>
<div class="data_common data_vertical">
 <table id="lstrc" >
  <tr class="hdb" align="center" nowrap>
   <th><% multilang("70" "LANG_INTERFACE"); %></th>
   <th><% multilang("2751" "LANG_MCAST_VLAN"); %></th>
   <th><% multilang("338" "LANG_MODIFY"); %></th>
  </tr>
 </table>
</div>
