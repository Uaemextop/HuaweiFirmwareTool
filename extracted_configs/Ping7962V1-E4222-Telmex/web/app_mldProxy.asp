...
<title><% multilang("26" "LANG_MLD_PROXY"); %><% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
var robust_count=0;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("26" "LANG_MLD_PROXY"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"><% multilang("430" "LANG_THIS_PAGE_BE_USED_TO_CONFIGURE_MLD_PROXY"); %></p>
</div>
 ...
 <div class="data_common data_common_notitle">
  <table>
   <tr id="proxy_enable">
    ...
    <td>
    <input type="radio" value="0" name="daemon" <% checkWrite("mldproxy0"); %> onClick="proxySelection()"><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="daemon" <% checkWrite("mldproxy1"); %> onClick="proxySelection()"><% multilang("255" "LANG_ENABLE"); %></td>
   </tr>
   <tr id="proxy_wan_if">
