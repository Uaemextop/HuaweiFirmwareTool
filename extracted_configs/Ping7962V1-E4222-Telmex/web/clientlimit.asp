...
<div class="data_common data_common_notitle">
 <table>
   <tr>
    ...
    <td>
        <input type="radio" value="0" name="clientlimitenable" onChange="clickenable()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
       <input type="radio" value="1" name="clientlimitenable" onChange="clickenable()"><% multilang("185" "LANG_ENABLED"); %>
       </td>
   </tr>
