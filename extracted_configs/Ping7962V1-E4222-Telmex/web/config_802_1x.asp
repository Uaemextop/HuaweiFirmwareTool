<%SendWebHeadStr(); %>
<title><% multilang("119" "LANG_802_1X_TITLE"); %> </title>
<SCRIPT>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("119" "LANG_802_1X_TITLE"); %> </p>
 <p class="intro_content"> <% multilang("120" "LANG_SUPPORT_LAN_PORT_802_1X"); %></p>
</div>
<form action=/boaform/formConfig_802_1x method=POST name="config_802_1x">
<div class="column clearfix">
        <div class="column_title">
                <div class="column_title_left"></div>
                <p><% multilang("245" "LANG_CONFIGURATION"); %></p>
...
<div class="column clearfix">
        <div class="column_title">
                <div class="column_title_left"></div>
                <p><% multilang("125" "LANG_PORT_TABLE"); %></p>
                <div class="column_title_right"></div>
        </div>
</div>
<div class="data_common">
<table>
 <tr>
                <th width="10%"><% multilang("6" "LANG_LAN"); %></th>
                <th width="15%"><% multilang("126" "LANG_ADMINISTRATIVE_STATE"); %></th>
                <th width="15%"><% multilang("127" "LANG_PORT_STATE"); %></th>
 </tr>
 <tr>
                <td width="5">1</td>
                <td width="15%">
   <select name="admin_state">
    <option selected value ="0"><% multilang("128" "LANG_FORCE_AUTHORIZED"); %></option>
    <option value="1"><% multilang("176" "LANG_AUTO"); %></option>
   </select>
  </td>
...
<div class="btn_ctl">
      ...
      <input class="link_bg" type="submit" value="<% multilang("441" "LANG_REFRESH"); %>" name="refresh" onClick="return on_submit()">&nbsp;&nbsp;
