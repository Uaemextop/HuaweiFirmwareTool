...
function showDhcpSvr(ip)
{
 ...
 if (document.dhcpd.dhcpdenable[0].checked == true)
  document.getElementById('displayDhcpSvr').innerHTML=
   '<div class="btn_ctl">'+
   '<input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return on_submit(this)">&nbsp;&nbsp;'+
   '</div>';
  ...
  document.getElementById('displayDhcpSvr').innerHTML=
   ...
   '</table></div>'+
   '<div class="btn_ctl">'+
   '<input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveClick(this)">&nbsp;&nbsp;'+
   '</div>';
  ...
  html +=
   ...
   '<input class="link_bg" type="button" value="<% multilang("368" "LANG_MAC_BASED_ASSIGNMENT"); %>" name="macIpTbl" onClick="macIpClick(\'/macIptbl.asp\')">'+
   '<input class="link_bg" type="button" value="<% multilang("4" "LANG_DEVICE"); %><% multilang("752" "LANG_IP_RANGE"); %>" name="clientIpTbl" onClick="clientIpClick(\'/devicetbl.asp\')">'+
    '</div>';
