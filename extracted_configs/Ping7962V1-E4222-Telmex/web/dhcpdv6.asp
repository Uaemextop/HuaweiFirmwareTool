...
function saveChanges(obj)
{
 if (document.dhcpd.dhcpRangeStart.value =="") {
  alert('<% multilang("2153" "LANG_START_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_2000_0200_10"); %>');
  ...
  if ( validateKeyV6IP(document.dhcpd.dhcpRangeStart.value) == 0) {
   alert('<% multilang("2154" "LANG_INVALID_START_IP"); %>');
   document.dhcpd.dhcpRangeStart.focus();
   return false;
  }
 }
 if (document.dhcpd.dhcpRangeEnd.value =="") {
  alert('<% multilang("2155" "LANG_END_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_2000_0200_20"); %>');
...
<form action=/boaform/formDhcpv6Server method=POST name="dhcpd">
 ...
 <div class="data_common data_common_notitle" id="ipv6_option_ntp" style="display:none;">
  <table>
   <tr>
   <th width="30%"><% multilang("3018" "LANG_NTP_SERVER"); %> IP:</th>
   <td><input type="text" name="NTPServerIP" size="15" maxlength="40">&nbsp;&nbsp;</td>
   <td><input type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="addNTPServer" class="inner_btn" onClick="return on_submit(this)">&nbsp;&nbsp;</td>
   </tr>
  </table>
  <div class="column">
   <div class="column_title">
    <div class="column_title_left"></div>
    <p><% multilang("3019" "LANG_NTP_SERVER_TABLE"); %></p>
    <div class="column_title_right"></div>
   </div>
   <div class="data_common data_vertical">
    <table>
   ...
   <div class="btn_ctl">
    <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delNTPServer" <% multilang("3019" "LANG_NTP_SERVER_TABLE"); %> onClick="return on_submit(this)">&nbsp;&nbsp;
    <input class="link_bg" type="submit" value="<% multilang("232" "LANG_DELETE_ALL"); %>" name="delAllNTPServer" <% multilang("3019" "LANG_NTP_SERVER_TABLE"); %> onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;
   </div>
  </div>
 </div>
 <div class="data_common data_common_notitle" id="ipv6_mac_binding" style="display:none;">
  <table>
   <tr>
   <th width="30%"><% multilang("382" "LANG_HOSTNAME"); %>:</th>
   <td><input type="text" name="hostName" size="15" maxlength="35">&nbsp;&nbsp;</td>
   <td><input type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="addMacBinding" class="inner_btn" onClick="return on_submit(this)">&nbsp;&nbsp;</td>
   </tr>
   <tr>
   <th width="30%"><% multilang("92" "LANG_MAC_ADDRESS"); %>:</th>
   <td><input type="text" name="macAddress" size="15" maxlength="40">&nbsp;&nbsp;</td>
   <td></td>
   </tr>
   <tr>
  ...
  <div class="column">
   <div class="column_title">
    <div class="column_title_left"></div>
    <p><% multilang("3020" "LANG_DHCPD_MAC_BINDING_TABLE"); %></p>
    <div class="column_title_right"></div>
   </div>
   <div class="data_common data_vertical">
    <table>
   ...
   <div class="btn_ctl">
    <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delMacBinding" <% multilang("3020" "LANG_DHCPD_MAC_BINDING_TABLE"); %> onClick="return on_submit(this)">&nbsp;&nbsp;
    <input class="link_bg" type="submit" value="<% multilang("232" "LANG_DELETE_ALL"); %>" name="delAllMacBinding" <% multilang("3020" "LANG_DHCPD_MAC_BINDING_TABLE"); %> onClick="return on_submit(this)">&nbsp;&nbsp;&nbsp;
   </div>
  </div>
 </div>
