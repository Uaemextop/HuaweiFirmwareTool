...
<div class="data_common data_vertical">
 <table>
  <tr>
   ...
   <th><% multilang("1123" "LANG_DUID"); %></th>
   <th><% multilang("169" "LANG_EXPIRED_TIME_SEC"); %></th>
  </tr>
  <% dhcpClientListv6(); %>
 </table>
</div>
<div class="btn_ctl">
 <input class="link_bg" type="button" value="<% multilang("441" "LANG_REFRESH"); %>" name="refresh" onClick="javascript: location.reload();">&nbsp;&nbsp;
