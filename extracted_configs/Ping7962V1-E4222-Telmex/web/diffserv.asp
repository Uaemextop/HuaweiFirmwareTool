<%SendWebHeadStr(); %>
<title><% multilang("790" "LANG_DIFFERENTIATED_SERVICES"); %></title>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("790" "LANG_DIFFERENTIATED_SERVICES"); %></p>
 <p class="intro_content"> <% multilang("791" "LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_TO_ASSIGN_THE_PRECEDENCE_FOR_EACH_INCOMING_PACKET_BASED_ON_TCP_UDP_PORT_NUMBER_SOURCE_DESTINATION_IP_ADDRESS_SUBNET_MASKS"); %></p>
</div>
<form action=/boaform/formDiffServ method=POST name=diffserv>
<% diffservList(); %>
<input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name=delSel onClick="return deleteClick()">
<div class="data_common data_common_notitle">
<table>
 <tr>
  <th><% multilang("790" "LANG_DIFFERENTIATED_SERVICES"); %>:</th>
  <td>
   <input type="radio" name=qoscap value=0 onClick="return adminClick()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
   <input type="radio" name=qoscap value=1 onClick="return adminClick()"><% multilang("185" "LANG_ENABLED"); %>
  </td>
 </tr>
 <TBODY id='diffservSetting'>
  <tr>
   <th><% multilang("792" "LANG_PHB_GROUPS"); %>:</th>
   <td>
  ...
  <tr>
   <th><% multilang("432" "LANG_WAN_INTERFACE"); %>:</th>
   <td>
  ...
  <tr>
   <th><% multilang("581" "LANG_MIN"); %>:</th>
   <td>100Kb</td>
  </tr>
  <tr>
   <th><% multilang(LANG_MAX); %>: </th>
   <td><% multilang("693" "LANG_TOTAL_BANDWIDTH_LIMIT"); %> - 100Kb</td>
  </tr>
  <tr>
   <th><% multilang("693" "LANG_TOTAL_BANDWIDTH_LIMIT"); %>:</th>
   <td><input type="text" name="totalbandwidth" size="6" maxlength="6" value="1024">Kb</td>
  </tr>
  <tr>
   <th><% multilang("794" "LANG_MAX_DESIRED_LATENCY"); %>:</th>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name=addqos onClick="return addClick(this.form.phb)">
