<%SendWebHeadStr(); %>
<title><% multilang("1237" "LANG_CFM_802_1AG_CONFIGURATION"); %></title>
...
function addClick(action,obj)
{
 ...
 {
  alert('<% multilang("2197" "LANG_YOU_MUST_SELECT_AN_ENTRY_IN_TABLE"); %>');
  return false;
 }
 if(action == "delete")
 {
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("1237" "LANG_CFM_802_1AG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("1238" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_IEEE_802_1AG_WHICH_IS_ALSO_KNOWN_AS_CONNECTIVITY_FAULT_MAMAGMENT"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
      <th width=30%><% multilang("1181" "LANG_MD_NAME"); %>:&nbsp;&nbsp;</th>
      <td><input type="text" name="md_name" size="20" maxlength="43"></td>
  </tr>
  <tr>
   <th width=30%><% multilang("1203" "LANG_MD_LEVEL"); %>:</th>
...
<div class="btn_ctl">
 <input type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="action" onClick="return addClick('add',this)">&nbsp;&nbsp;
 <input type="submit" value="<% multilang("315" "LANG_DELETE"); %>" name="action" onClick="return addClick('delete',this)">&nbsp;&nbsp;
 <input type="submit" value="<% multilang("338" "LANG_MODIFY"); %>" name="action" onClick="return addClick('modify',this)">&nbsp;&nbsp
 <input type="button" value="<% multilang("879" "LANG_CLEAR"); %>" onClick="clear_inputs(1)">&nbsp;&nbsp;
 <input type="hidden" value="/dot1ag_conf.asp" name="submit-url">
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("1240" "LANG_CFM_INSTANCE_TABLE"); %></p>
 ...
 <div class="data_common">
  <table id="cfm_tbl">
   <tr>
    ...
    <th align=center><% multilang("1181" "LANG_MD_NAME"); %></th>
    <th align=center><% multilang(LANG_MD_LVEL); %></th>
    <th align=center><% multilang("1182" "LANG_MA_NAME"); %></th>
    <th align=center><% multilang("1204" "LANG_MEP_ID"); %></th>
    <th align=center><% multilang("1205" "LANG_CCM_STATUS"); %></th>
   </tr>
  </table>
 </div>
</div>
