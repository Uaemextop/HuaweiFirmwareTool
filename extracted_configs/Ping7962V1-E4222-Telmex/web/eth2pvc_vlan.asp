<%SendWebHeadStr(); %>
<title><% multilang("39" "LANG_PORT_MAPPING"); %><% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
function adminClick()
{
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("39" "LANG_PORT_MAPPING"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("783" "LANG_TO_MANIPULATE_A_MAPPING_GROUP"); %>:<br>
    <b>1.</b> <% multilang("784" "LANG_SELECT_A_GROUP_FROM_THE_TABLE"); %><br>
    <b>2.</b> <% multilang("785" "LANG_SELECT_INTERFACES_FROM_THE_AVAILABLE_GROUPED_INTERFACE_LIST_AND_ADD_IT_TO_THE_GROUPED_AVAILABLE_INTERFACE_LIST_USING_THE_ARROW_BUTTONS_TO_MANIPULATE_THE_REQUIRED_MAPPING_OF_THE_PORTS"); %><br>
    <b>3.</b> <% multilang("786" "LANG_CLICK_APPLY_CHANGES_BUTTON_TO_SAVE_THE_CHANGES"); %><br><br>
    <b><% multilang("787" "LANG_NOTE_THAT_THE_SELECTED_INTERFACES_WILL_BE_REMOVED_FROM_THEIR_EXISTING_GROUPS_AND_ADDED_TO_THE_NEW_GROUP"); %></p>
</div>
<form action=/boaform/formVlanGroup method=POST name="eth2pvc">
<div class="data_common data_common_notitle">
 <table>
  <th>
   <input type="radio" name=pmap value=0 onClick="return adminClick()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
   <input type="radio" name=pmap value=1 onClick="return adminClick()"><% multilang("185" "LANG_ENABLED"); %>
  </th>
 </table>
</div>
<div class="data_common data_common_notitle">
 <table>
    <tr>
       <th width="150"><% multilang("788" "LANG_GROUPED_INTERFACES"); %></th>
       <th width="100"></th>
       <th width="150"><% multilang("789" "LANG_AVAILABLE_INTERFACES"); %></th>
    </tr>
    <!--
...
<div class="btn_ctl">
      ...
      <input class="link_bg" type=submit value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" onClick=btnApply()>&nbsp;&nbsp;
