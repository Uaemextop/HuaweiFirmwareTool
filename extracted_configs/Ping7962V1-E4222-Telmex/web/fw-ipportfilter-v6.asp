...
function addClick(obj)
{
 ...
 if(sip6End.value != ""){
  if (! isGlobalIpv6Address(sip6End.value) ){
   alert('<% multilang("2233" "LANG_INVALID_SOURCE_IPV6_END_ADDRESS"); %>');
 ...
 if(dip6End.value != ""){
  if (! isGlobalIpv6Address(dip6End.value) ){
   alert('<% multilang("2237" "LANG_INVALID_DESTINATION_IPV6_END_ADDRESS"); %>');
...
<table>
 <tr <% checkWrite("rg_hidden_function"); %>>
  ...
  <td width="70%">
   <input type="radio" name="outAct" value=0 <% checkWrite("v6_ipf_out_act0"); %>><% multilang("390" "LANG_DENY"); %>&nbsp;&nbsp;
      <input type="radio" name="outAct" value=1 <% checkWrite("v6_ipf_out_act1"); %>><% multilang("391" "LANG_ALLOW"); %>&nbsp;&nbsp;
  </td>
 </tr>
 <tr <% checkWrite("rg_hidden_function"); %>>
  <th width="30%"><% multilang("392" "LANG_INCOMING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
  <td width="70%">
   <input type="radio" name="inAct" value=0 <% checkWrite("v6_ipf_in_act0"); %>><% multilang("390" "LANG_DENY"); %>&nbsp;&nbsp;
      <input type="radio" name="inAct" value=1 <% checkWrite("v6_ipf_in_act1"); %>><% multilang("391" "LANG_ALLOW"); %>&nbsp;&nbsp;
  </td>
 </tr>
</table>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th><% multilang("396" "LANG_RULE_ACTION"); %>:</th>
 ...
 <table>
    <tr>
    <th width="30%"><% multilang("397" "LANG_SOURCE"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>:</th>
