...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="40%"><% multilang("403" "LANG_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
   <td width="30%">
    <input type="radio" name="outAct" value=0 <% checkWrite("ipf_out_act0"); %>><% multilang("390" "LANG_DENY"); %>&nbsp;&nbsp;
    <input type="radio" name="outAct" value=1 <% checkWrite("ipf_out_act1"); %>><% multilang("391" "LANG_ALLOW"); %>
   </td>
   <td width="30%">
    <input class="inner_btn" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="setDefaultAction" onClick="return on_submit(this)">
   </td>
  </tr>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <th colspan=2><% multilang("396" "LANG_RULE_ACTION"); %>:&nbsp;&nbsp;
  ...
  <tr>
   <th width="40%">
    <% multilang("397" "LANG_SOURCE"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>: <input type="text" name="sip" size="10" maxlength="15"></th>
   <th width="30%"><% multilang("90" "LANG_SUBNET_MASK"); %>: <input type="text" name="smask" size="10" maxlength="15"></th>
   <th width="30%"><% multilang("220" "LANG_PORT"); %>:
    <input type="text" name="sfromPort" size="4" maxlength="5">-
    <input type="text" name="stoPort" size="4" maxlength="5">
   </th>
  </tr>
  <tr>
   <th width="40%"><% multilang("398" "LANG_DESTINATION"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>: <input type="text" name="dip" size="10" maxlength="15"></th>
