<%SendWebHeadStr(); %>
<title>MAC <% multilang("387" "LANG_FILTERING"); %></title>
<script>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("1178" "LANG_MAC_FILTERING_FOR_BRIDGE_MODE"); %></p>
 <p class="intro_content"> <% multilang("402" "LANG_PAGE_DESC_LAN_TO_INTERNET_DATA_PACKET_FILTER_TABLE"); %></p>
</div>
 ...
 <table>
  <tr>
   <th width="30%"><% multilang("389" "LANG_OUTGOING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
      <td width="70%">
    <input type="radio" name="outAct" value=0 <% checkWrite("macf_out_act0"); %>><% multilang("390" "LANG_DENY"); %>&nbsp;&nbsp;
       <input type="radio" name="outAct" value=1 <% checkWrite("macf_out_act1"); %>><% multilang("391" "LANG_ALLOW"); %>&nbsp;&nbsp;
   </td>
  </tr>
  <tr style="display: none;">
   <th width="30%"><% multilang("392" "LANG_INCOMING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
   <td width="70%">
    <input type="radio" name="inAct" value=0 <% checkWrite("macf_in_act0"); %>><% multilang("390" "LANG_DENY"); %>&nbsp;&nbsp;
       <input type="radio" name="inAct" value=1 <% checkWrite("macf_in_act1"); %>><% multilang("391" "LANG_ALLOW"); %>&nbsp;&nbsp;
   </td>
  </tr>
 </table>
</div>
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="setMacDft" onClick="return on_submit(this)">&nbsp;&nbsp;
...
<table>
 ...
 <tr>
  <th>
   <% multilang("397" "LANG_SOURCE"); %> <% multilang("92" "LANG_MAC_ADDRESS"); %>:
  </th>
  <td>
 ...
 <tr style="display: none;">
  <th><% multilang("398" "LANG_DESTINATION"); %> <% multilang("92" "LANG_MAC_ADDRESS"); %>: </th>
     <td>
