 ...
 <table>
  <tr>
   <th width="30%"><% multilang("143" "LANG_MODE"); %>:&nbsp;&nbsp;</th>
      <td width="40%">
       <input type="radio" name="outAct" value=0 <% checkWrite("macf_out_act0"); %>><% multilang("2755" "LANG_WHITE_LIST"); %>&nbsp;&nbsp;
       <input type="radio" name="outAct" value=1 <% checkWrite("macf_out_act1"); %>><% multilang("2756" "LANG_BLACK_LIST"); %>&nbsp;&nbsp;</th>
   </td>
   <td>
    <input class="inner_btn" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="setMacDft" onClick="return on_submit(this)">&nbsp;&nbsp;
   </td>
  <tr>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td>
    <input class="inner_btn" type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="addFilterMac" onClick="return addClick(this)">&nbsp;&nbsp;
   </td>
  </tr>
  <input type="hidden" value="/admin/fw-macfilter_rg.asp" name="submit-url">
  <input type="hidden" name="postSecurityFlag" value="">
