<%SendWebHeadStr(); %>
<title>Interface Grouping <% multilang("245" "LANG_CONFIGURATION"); %></title>
<script>
...
<body onLoad="formLoad();">
 <div class="intro_main ">
  <p class="intro_title">Interface Grouping <% multilang("245" "LANG_CONFIGURATION"); %></p>
 </div>
 <form action="/boaform/formInterfaceGrouping" method="POST" name="InterfaceGroupingform">
  <div class="data_common data_common_notitle">
   <table>
    <tr>
     <th width="30%"><% multilang("233" "LANG_SELECT"); %>:</th>
     <td width="70%">
   ...
   <table>
    <tr align="center">
     <td><b><% multilang("788" "LANG_GROUPED_INTERFACES"); %></b></td>
     <td></td>
     <td><b><% multilang("789" "LANG_AVAILABLE_INTERFACES"); %></b></td>
    </tr>
    <tr align="center">
     <td>
  ...
  <div class="column">
   ...
   <div class="data_common data_vertical">
    <table>
    <tr>
     <th align=center width="25%"><% multilang("700" "LANG_NAME"); %></th>
     <th align=center width="15%"><% multilang("3" "LANG_STATUS"); %></th>
     <th align=center width="50%"><% multilang("2912" "LANG_INTERFACES"); %></th>
     <th align=center width="10%"><% multilang("710" "LANG_ACTION"); %></th>
    </tr>
    <script language="javascript">
    ...
    for (i = 0; i < InterfaceGroupingKey.length; i++)
    {
     ...
     document.write("<td>" + ((InterfaceGroupingEnable[i] == "0") ? "<% multilang("254" "LANG_DISABLE"); %>":"<% multilang("255" "LANG_ENABLE"); %>") + "</td>");
     member_list = "";
     for (j = 0; j < InterfaceList_Domain.length; j++)
     {
      if (InterfaceGroupingKey[i] == InterfaceList_Group[j])
