...
function addClick(obj)
{
 ...
 if( document.qos.queuekey.value ==-1) {
  alert('<% multilang("2272" "LANG_PLEASE_SELECT_QUEUE"); %>');
...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("670" "LANG_CONFIGURATION_OF_CLASSIFICATION_TABLE_FOR_IPQOS"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th>IP QoS:</th>
   <td><input type="radio" name=qosen value=0 onClick="return adminClick()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
    <input type="radio" name=qosen value=1 onClick="return adminClick()"><% multilang("185" "LANG_ENABLED"); %>
   </td>
  </tr>
  <tr>
   <% dft_qos(); %>
 ...
 <div class="data_common">
  <table>
   ...
   <tr>
    ...
    <th><% multilang("663" "LANG_PHYSICAL_PORT"); %>:
     <select name=phyport>
     <option value=0></option>
     <% if_lan_list("all"); %>
    </select>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("672" "LANG_CLASSIFICATION_RESULTS"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
   <tr>
    <th><% multilang("673" "LANG_CLASSQUEUE"); %>:
     <% pq_egress(); %>
    </th>
    <th>802.1p_Mark:
     <select name=m1p>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("228" "LANG_ADD"); %>" name=addqos onClick="return addClick(this)"></td>
