<%SendWebHeadStr(); %>
<title>IP QoS <% multilang("40" "LANG_CLASSIFICATION"); %></title>
<script>
...
function addClick(obj)
{
 if ((document.qos.sip.value == "") && (document.qos.smask.value == "") && (document.qos.sport.value == "")
  ...
  alert('<% multilang("2271" "LANG_TRAFFIC_CLASSIFICATION_RULES_CAN_T_BE_EMPTY"); %>');
...
<div class="intro_main ">
 <p class="intro_title">IP QoS <% multilang("40" "LANG_CLASSIFICATION"); %></p>
 <p class="intro_content"> <% multilang("657" "LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_TO_ASSIGN_THE_PRECEDENCE_FOR_EACH_INCOMING_PACKET_IF_DISABLE_IP_QOS_TRAFFIC_SHAPING_WILL_BE_EFFECTIVE_OTHERWISE_TRAFFIC_SHAPING_IS_INVALID"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th>IP QoS:</th>
   <td>
    <input type="radio" name=qosen value=0 onClick="return adminClick()"><font size=2><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
    <input type="radio" name=qosen value=1 onClick="return adminClick()"><font size=2><% multilang("185" "LANG_ENABLED"); %>
   </td>
  </tr>
  <tr>
   <th><% multilang("658" "LANG_POLICY"); %>:</th>
   <td>
...
<div class="btn_ctl">
 <input class="link_bg" type=submit value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name=admin onClick="return on_submit(this)">
</div>
...
<div class="column">
 ...
 <div class="data_common">
  <table>
   ...
   <tr><th><% multilang("397" "LANG_SOURCE"); %> IP:</th><td><input type=text name=sip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
   <tr><th><% multilang("661" "LANG_SOURCE_MASK"); %>:</th><td><input type=text name=smask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
   <tr><th><% multilang("400" "LANG_SOURCE_PORT"); %>:</th><td><input type=text name=sport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
   <tr><th><% multilang("398" "LANG_DESTINATION"); %> IP:</th><td><input type=text name=dip size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
   <tr><th><% multilang("662" "LANG_DESTINATION_MASK"); %>:</th><td><input type=text name=dmask size=20 maxlength=15 onChange="onchange_sel1();"></td></tr>
   <tr><th><% multilang("401" "LANG_DESTINATION_PORT"); %>:</th><td><input type=text name=dport size=10 maxlength=5 onChange="onchange_sel1();"></td></tr>
    <th><% multilang("663" "LANG_PHYSICAL_PORT"); %>:</th>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("664" "LANG_ASSIGN_PRIORITY_AND_OR_IP_PRECEDENCE_AND_OR_TYPE_OF_SERVICE_AND_OR_DSCP"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
   <tr><th><% multilang("665" "LANG_OUTBOUND_PRIORITY"); %>:</th>
    <td>
     <% pq_egress(); %>
    </td>
   </tr>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("228" "LANG_ADD"); %>" name=addqos onClick="return addClick(this)">
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p>IP QoS <% multilang("666" "LANG_RULES"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
...
<div class="btn_ctl">
  ...
  <input class="link_bg" type="submit" value="<% multilang("232" "LANG_DELETE_ALL"); %>" name=delAll onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
  <input type="hidden" value="/ipqos_sc.asp" name="submit-url">
  <input type="hidden" name="postSecurityFlag" value="">
</div>
</form>
