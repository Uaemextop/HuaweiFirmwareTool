...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("667" "LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_FOR_TRAFFIC_CONTROL"); %></p>
</div>
...
<div id="traffictl_tbl" class="data_vertical data_common_notitle">
  ...
  <table>
   <tr>
    ...
    <th><% multilang("397" "LANG_SOURCE"); %> Port</th>
    <th><% multilang("398" "LANG_DESTINATION"); %> Port</th>
...
<div class="btn_ctl">
 <input class="link_bg" type="button" onClick="on_Add()" value="<% multilang("228" "LANG_ADD"); %>">
 <input class="link_bg" type="button" onClick="on_submit(this);" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>">
 <input class="link_bg" type="button" onClick="on_apply_bandwidth(this);" value="<% multilang("669" "LANG_APPLY_TOTAL_BANDWIDTH_LIMIT"); %>">
</div>
