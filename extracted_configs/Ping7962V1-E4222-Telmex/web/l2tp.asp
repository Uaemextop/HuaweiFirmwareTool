...
function addL2TPItf(obj)
{
 ...
 {
  alert('<% multilang("2282" "LANG_INVALID_VALUE_IN_SERVER_ADDRESS"); %>');
  document.l2tp.server.focus();
  return false;
 }
 if (document.l2tp.tunnel_auth.checked)
 ...
 if (document.l2tp.pppconntype.selectedIndex==1)
 {
  ...
  {
   alert('<% multilang("2290" "LANG_PLEASE_SELECT_DEFAULT_GATEWAY_FOR_DIAL_ON_DEMAND"); %>');
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th><% multilang("301" "LANG_IDLE_TIME_SEC"); %>:</td>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="addL2TP" onClick="return addL2TPItf(this)">&nbsp;&nbsp;</td>
</div>
<div class="column">
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delSel" onClick="return deleteClick(this)">&nbsp;&nbsp;
