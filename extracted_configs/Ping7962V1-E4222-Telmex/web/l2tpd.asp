...
function checkTextStr(obj)
{
 if(obj.value.length > 30){
  alert('<% multilang("2292" "LANG_LENGTH_SHOULD_LESS_THEN_32"); %>');
  obj.focus();
  return false;
 }
 for (var i=0; i<obj.value.length; i++)
 {
  ...
  {
   alert('<% multilang("2293" "LANG_INVALID_CHARACTER_IN_TEXT_AERA"); %>');
   obj.focus();
   return false;
  }
 }
...
function setL2tpServer(obj)
{
 ...
 if (document.l2tp.peeraddr.value=="") {
  alert('<% multilang("2294" "LANG_PLEASE_ENTER_PEER_START_ADDRESS"); %>');
 ...
 if (document.l2tp.localaddr.value=="") {
  alert('<% multilang("2295" "LANG_PLEASE_ENTER_LOCAL_ADDRESS"); %>');
...
function addL2tpAccount(obj)
{
 ...
 if (document.l2tp.s_name.value=="") {
  alert('<% multilang("2296" "LANG_PLEASE_ENTER_L2TP_SERVER_RULE_NAME"); %>');
  document.l2tp.s_name.focus();
  return false;
 }
 if(document.l2tp.s_tunnelAuth.checked){
  if(document.l2tp.s_authKey.value ==""){
   alert('<% multilang("2297" "LANG_PLEASE_ENTER_L2TP_TUNNEL_AUTHKEY"); %>');
 ...
 {
  alert('<% multilang("2298" "LANG_PLEASE_ENTER_L2TP_SERVER_USERNAME"); %>');
 ...
 if (document.l2tp.s_password.value=="") {
  alert('<% multilang("2299" "LANG_PLEASE_ENTER_L2TP_SERVER_PASSWORD"); %>');
...
function addL2tpClient(obj)
{
 ...
 if (document.l2tp.c_name.value=="") {
  alert('<% multilang("2300" "LANG_PLEASE_ENTER_L2TP_CLIENT_RULE_NAME"); %>');
 ...
 if (document.l2tp.mtu.value=="") {
  alert('<% multilang("2301" "LANG_PLEASE_ENTER_L2TP_CLIENT_MTU"); %>');
 ...
 <div class="data_common">
  <table>
   ...
   <tr>
    <th>Tunnel:</th>
    <td>
     <input type="radio" value="0" name="tunnelen"><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
     <input type="radio" value="1" name="tunnelen" checked><% multilang("255" "LANG_ENABLE"); %>
    </td>
   </tr>
   <tr>
    <th>Username:</th>
...
<div class="column">
 ...
 <div class="data_common">
  <table>
   <tr>
    <th align=center><% multilang("233" "LANG_SELECT"); %></th>
    <th align=center><% multilang("700" "LANG_NAME"); %></th>
    <th align=center><% multilang("255" "LANG_ENABLE"); %></th>
    <th align=center><% multilang("1166" "LANG_USERNAME"); %></th>
    <th align=center><% multilang("67" "LANG_PASSWORD"); %></th>
   </tr>
   <% l2tpServerList(); %>
  </table>
 </div>
 ...
 <div class="data_common">
  <table>
   <tr>
    ...
    <th align=center width="5%"><% multilang("700" "LANG_NAME"); %></th>
    <th align=center width="5%"><% multilang("91" "LANG_SERVER"); %></th>
    <th align=center width="5%"><% multilang("1230" "LANG_TUNNEL_AUTH"); %></th>
    <th align=center width="5%"><% multilang("1231" "LANG_PPP_AUTH"); %></th>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delSelClient" onClick="return on_submit(this)">&nbsp;&nbsp;
