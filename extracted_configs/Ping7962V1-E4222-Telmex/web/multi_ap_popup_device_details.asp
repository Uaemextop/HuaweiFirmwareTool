<% SendWebHeadStr();%>
<title><% multilang("283" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("283" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></p>
 <p class="intro_content"><% multilang("284" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS_DESC"); %></p>
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("285" "LANG_WLAN_EASY_MESH_NEIGHBOR_RSSI"); %>:</p>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("286" "LANG_WLAN_EASY_MESH_STA_INFO"); %>:</p>
  <div class="column_title_right"></div>
</div>
<div class="data_common">
...
<div class="btn_ctl">
  ...
  <input type="button" value="<% multilang("441" "LANG_REFRESH"); %>" class="link_bg" onclick="location.reload(true);">&nbsp;&nbsp;
  <input type="button" value="<% multilang("742" "LANG_CLOSE"); %>" class="link_bg" name="close" onClick="javascript: window.close();">
</div>
</form>
</body>
</html>
