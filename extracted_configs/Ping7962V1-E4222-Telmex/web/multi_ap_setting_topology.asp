<% SendWebHeadStr();%>
<title><% multilang("279" "LANG_WLAN_EASY_MESH_TOPOLOGY"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("279" "LANG_WLAN_EASY_MESH_TOPOLOGY"); %></p>
 <p class="intro_content"><% multilang("280" "LANG_WLAN_EASY_MESH_TOPOLOGY_DESC"); %></p>
</div>
<form action=/boaform/formMultiAP method=POST name="MultiAP">
<div id="other_div" style="display:none">
<div class="data_common data_common_notitle">
<table><tr><td>
<% multilang("281" "LANG_WLAN_EASY_MESH_ROLE_IS_NOT_CONTROLLER"); %>
</td></tr></table>
</div>
</div>
...
<table>
 ...
 <td width="100%" colspan=2><font size=2><b>
  <input type="checkbox" name="" value="ON" ONCLICK="">&nbsp;&nbsp;Disable EasyMesh</b>
   ...
   <tr>
  <th><% multilang("282" "LANG_NETWORK_TOPOLOGY"); %>:</th>
 </tr>
 <tr>
 <td>
