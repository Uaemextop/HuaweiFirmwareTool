<%SendWebHeadStr(); %>
<TITLE>QoS <% multilang("40" "LANG_CLASSIFICATION"); %></TITLE>
 ...
 for(var i = 0; i < rules.length; i++)
 {
  ...
  switch(rules[i].ipqos_rule_type)
  {
   ...
   case 2:
    ...
    {
     case 1:
      cell.innerHTML += "Protocol: IPv4<br>";
      ...
      break;
     case 2:
      cell.innerHTML += "Protocol: IPv6<br>";
      if (rules[i].sip6 == "::")
       cell.innerHTML += "Source IP: "+ " <br>";
      else {
      ...
      break;
     case 3:
      cell.innerHTML += "Protocol: IPv4/IPv6<br>";
      break;
    }
    if(rules[i].dscp != 0)
     cell.innerHTML+= "DSCP: "+dscps[rules[i].dscp]+"<br>";
...
<div class="intro_main ">
 <p class="intro_title">QoS <% multilang("40" "LANG_CLASSIFICATION"); %></p>
 <p class="intro_content"> <% multilang("694" "LANG_PAGE_DESC_CLASSICY_QOS_RULE"); %><font color="red">(<% multilang("695" "LANG_PAGE_DESC_CLASSICY_QOS_RULE_EXTRA"); %>)</font></p>
</div>
...
<div class="data_common data_common_notitle">
 <div class="data_common data_vertical">
  <table id="lstrc" >
   <tr>
    <th colspan="2">&nbsp;</th>
    <th colspan="3" align="center"><% multilang("697" "LANG_MARK"); %></th>
    <th colspan="3"><% multilang("696" "LANG_CLASSIFICATION_RULES"); %></th>
    <th colspan="3" align="center">&nbsp;</th>
   </tr>
   <tr>
    <td><% multilang("698" "LANG_ID"); %></td>
    <td><% multilang("700" "LANG_NAME"); %></td>
    <td>Order</td>
    <!--<td><% multilang("135" "LANG_VLAN_ID"); %></td>-->
    <td>DSCP <% multilang("697" "LANG_MARK"); %></td>
    <td><% multilang("704" "LANG_802_1P"); %></td>
    <td> <% multilang("689" "LANG_QUEUE"); %></td>
    <td> <% multilang("705" "LANG_WANIF"); %></td>
    <td><% multilang("706" "LANG_RULE_DETAIL"); %></td>
    <td><% multilang("315" "LANG_DELETE"); %></td>
    <td><% multilang("702" "LANG_EDIT"); %></td>
    <td>&nbsp;</td>
   </tr>
  </table>
 </div>
...
<div class=btn_ctl>
 <input class=link_bg type="button" class="button" onClick="location.href='net_qos_cls_edit.asp';" value="<% multilang("228" "LANG_ADD"); %>">
