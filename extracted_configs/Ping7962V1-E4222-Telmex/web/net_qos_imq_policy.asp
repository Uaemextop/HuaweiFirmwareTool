<%SendWebHeadStr(); %>
<title>IP QoS <% multilang("245" "LANG_CONFIGURATION"); %></title>
...
<div class="intro_main ">
 <p class="intro_title">IP QoS <% multilang("245" "LANG_CONFIGURATION"); %></p>
</div>
<form id="form" action="/boaform/admin/formQosPolicy" method="post">
<div class="data_common data_common_notitle">
 <table>
  <tr>
     <th><% multilang("1298" "LANG_IP_QOS"); %></th>
   <td><input type="radio" name=qosen value=0 onClick=qosen_click();><% multilang("254" "LANG_DISABLE"); %></td>
   <td><input type="radio" name=qosen value=1 onClick=qosen_click();><% multilang("255" "LANG_ENABLE"); %></td>
  </tr>
 </table>
</div>
<div id="qosPly" style="display:none">
 <div class="column">
  <div class="column_title">
   ...
   <p>QoS <% multilang("685" "LANG_QUEUE_CONFIG"); %></p>
   <div class="column_title_right"></div>
  </div>
   <div class="data_common">
   <table>
    <tr>
     <td colspan=3><% multilang("686" "LANG_PAGE_DESC_CONFIGURE_QOS_POLICY"); %></td>
    </tr>
    <tr>
     <th width=30%><% multilang("658" "LANG_POLICY"); %>:</th>
     <td width=35%><input type="radio" name="queuepolicy" value="prio" onClick=qpolicy_click();><% multilang("687" "LANG_PRIO"); %></td>
     <td width=35%><input type="radio" name="queuepolicy" value="wrr" onClick=qpolicy_click();><% multilang("688" "LANG_WRR"); %></td>
    </tr>
   </table>
  </div>
  <div class="data_common data_vertical">
   <table id="lstrc">
    <tr class="hdb" align="center">
     <th><% multilang("689" "LANG_QUEUE"); %></th>
     <th><% multilang("658" "LANG_POLICY"); %></th>
     <th><% multilang("690" "LANG_PRIORITY"); %></th>
     <th><% multilang("659" "LANG_WEIGHT"); %></th>
     <th><% multilang("255" "LANG_ENABLE"); %></th>
    </tr>
   </table>
  </div>
 </div>
 <div id="ttusbandwidth" class="column" style="display:none">
  ...
  <div class="data_common">
   <table>
    <tr>
     <td colspan=3><% multilang("691" "LANG_PAGE_DESC_CONFIGURE_BANDWIDTH"); %></td>
    </tr>
    <tr>
     <th><% multilang("692" "LANG_USER_DEFINED_BANDWIDTH"); %>:</th>
    ...
    <tr>
    <th colspan=1> <% multilang("693" "LANG_TOTAL_BANDWIDTH_LIMIT"); %>:</th><td colspan=2><input type="text" name="totalbandwidth" id="totalbandwidth" value="1005">Kb</td>
    </tr>
   </table>
  </div>
 </div>
...
<div class="btn_ctl">
  <input class="link_bg" type="button" class="button" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" onClick="on_save();">
