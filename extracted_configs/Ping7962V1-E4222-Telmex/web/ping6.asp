<% SendWebHeadStr();%>
<title>Ping6 <% multilang("44" "LANG_DIAGNOSTICS"); %></title>
<SCRIPT>
function goClick()
{
...
<div class="intro_main ">
 <p class="intro_title">Ping6 <% multilang("44" "LANG_DIAGNOSTICS"); %></p>
 <p class="intro_content"> <% multilang("497" "LANG_PAGE_DESC_ICMPV6_DIAGNOSTIC"); %></p>
</div>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value=" <% multilang("501" "LANG_GO"); %>" name="go" onClick="return goClick()">
