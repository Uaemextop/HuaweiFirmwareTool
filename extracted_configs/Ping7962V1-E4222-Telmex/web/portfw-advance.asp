...
function PFWApply(obj) {
 ...
 alert("<% multilang("2375" "LANG_LOCAL_IP_ADDRESS_CANNOT_BE_EMPTY"); %>");
 ...
 alert("<% multilang("2376" "LANG_RULE_CANNOT_BE_EMPTY_PLEASE_CHOOSE_ONE_GATEGORY_AND_SELECT_ONE_AVAILABLE_RULE_THEN_ADD_INTO_APPLIED_RULE"); %>");
 return false;
   }
   with ( document.portfwAdvance ) {
      for (i = 0; i < lstApply.options.length; i++)
...
<div class="data_common data_common_notitle">
   <table>
      <tr>
          <th><% multilang("882" "LANG_CATEGORY"); %>: </th>
          <td>
...
<div class="data_common data_common_notitle">
   <table>
      <tr>
         <th><% multilang("883" "LANG_AVAILABLE_RULES"); %></th>
         <td></td>
         <th><% multilang("884" "LANG_APPLIED_RULES"); %></th>
      </tr>
      <tr>
         <td>
...
<div class="btn_ctl">
 <input class="link_bg" type=submit value="<% multilang("228" "LANG_ADD"); %>" name="save" onClick="return PFWApply(this)">&nbsp;&nbsp;
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("885" "LANG_PORT_FORWARDING_ADVANCE_TABLE"); %></p>
...
<div class="btn_ctl">
   ...
   <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delRule" onClick="return on_submit(this)">&nbsp;&nbsp;
   <input class="link_bg" type="submit" value="<% multilang("232" "LANG_DELETE_ALL"); %>" name="delAllRule" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
