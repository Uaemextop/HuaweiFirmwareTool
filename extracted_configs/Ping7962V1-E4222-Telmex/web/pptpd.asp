<%SendWebHeadStr(); %>
<title>PPTP VPN <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
function addPptpAccount(obj)
{
 ...
 if (document.pptp.s_name.value=="") {
  alert("<% multilang("2380" "LANG_PLEASE_ENTER_PPTP_SERVER_RULE_NAME"); %>");
  document.pptp.c_name.focus();
  return false;
 }
 if (document.pptp.s_username.value=="")
 {
  alert("<% multilang("2381" "LANG_PLEASE_ENTER_PPTP_SERVER_USERNAME"); %>");
 ...
 if (document.pptp.s_password.value=="") {
  alert("<% multilang("2382" "LANG_PLEASE_ENTER_PPTP_SERVER_PASSWORD"); %>");
...
function addPptpClient(obj)
{
 ...
 if (document.pptp.c_name.value=="") {
  alert("<% multilang("2383" "LANG_PLEASE_ENTER_PPTP_CLIENT_RULE_NAME"); %>");
  document.pptp.c_name.focus();
  return false;
 }
 if (document.pptp.c_addr.value=="") {
  alert("<% multilang("2377" "LANG_PLEASE_ENTER_PPTP_SERVER_ADDRESS"); %>");
 ...
 {
  alert("<% multilang("2378" "LANG_PLEASE_ENTER_PPTP_CLIENT_USERNAME"); %>");
 ...
 if (document.pptp.c_password.value=="") {
  alert("<% multilang("2379" "LANG_PLEASE_ENTER_PPTP_CLIENT_PASSWORD"); %>");
...
<div class="intro_main ">
 <p class="intro_title">PPTP VPN <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("709" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_PPTP_MODE_VPN"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th>PPTP VPN:</th>
   <td>
    <input type="radio" value="0" name="pptpen" <% checkWrite("pptpenable0"); %> onClick="onClickPPtpEnable()"><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="pptpen" <% checkWrite("pptpenable1"); %> onClick="onClickPPtpEnable()"><% multilang("255" "LANG_ENABLE"); %>
   </td>
  </tr>
 </table>
</div>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delSelAccount" onClick="return on_submit(this)">&nbsp;&nbsp;
 <input class="link_bg" type="submit" value="<% multilang("864" "LANG_SAVE"); %>" name="saveAccount" onClick="return on_submit(this)">
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
 ...
 <div class="data_common">
  <table>
   <tr>
    ...
    <th align=center><% multilang("91" "LANG_SERVER"); %></th>
    <th align=center><% multilang("710" "LANG_ACTION"); %></th>
   </tr>
   <% pptpList(); %>
  </table>
 </div>
