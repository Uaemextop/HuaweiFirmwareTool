<% SendWebHeadStr();%>
<title>RADVD <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
function resetClick()
{
...
function saveChanges()
{
 if (document.radvd.MaxRtrAdvIntervalAct.value.length !=0) {
  if ( checkDigit(document.radvd.MaxRtrAdvIntervalAct.value) == 0) {
   alert("<% multilang("2384" "LANG_INVALID_MAXRTRADVINTERVAL_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( MaxRAI < 4 || MaxRAI > 1800 ) {
  alert("<% multilang("2385" "LANG_MAXRTRADVINTERVAL_MUST_BE_NO_LESS_THAN_4_SECONDS_AND_NO_GREATER_THAN_1800_SECONDS"); %>");
  document.radvd.MaxRtrAdvIntervalAct.focus();
  return false;
 }
 if (document.radvd.MinRtrAdvIntervalAct.value.length !=0) {
  if ( checkDigit(document.radvd.MinRtrAdvIntervalAct.value) == 0) {
   alert("<% multilang("2386" "LANG_INVALID_MINRTRADVINTERVAL_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( MinRAI < 3 || MinRAI > MaxRAI075 ) {
  alert("<% multilang("2387" "LANG_MINRTRADVINTERVAL_MUST_BE_NO_LESS_THAN_3_SECONDS_AND_NO_GREATER_THAN_0_75_MAXRTRADVINTERVAL"); %>");
  document.radvd.MinRtrAdvIntervalAct.focus();
  return false;
 }
 if (document.radvd.AdvCurHopLimitAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvCurHopLimitAct.value) == 0) {
   alert("<% multilang("2388" "LANG_INVALID_ADVCURHOPLIMIT_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvDefaultLifetimeAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvDefaultLifetimeAct.value) == 0) {
   alert("<% multilang("2389" "LANG_INVALID_ADVDEFAULTLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( dlt != 0 && (dlt < MaxRAI || dlt > 9000) ) {
  alert("<% multilang("2390" "LANG_ADVDEFAULTLIFETIME_MUST_BE_EITHER_ZERO_OR_BETWEEN_MAXRTRADVINTERVAL_AND_9000_SECONDS"); %>");
  document.radvd.AdvDefaultLifetimeAct.focus();
  return false;
 }
 if (document.radvd.AdvReachableTimeAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvReachableTimeAct.value) == 0) {
   alert("<% multilang("2391" "LANG_INVALID_ADVREACHABLETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvRetransTimerAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvRetransTimerAct.value) == 0) {
   alert("<% multilang("2392" "LANG_INVALID_ADVRETRANSTIMER_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.AdvLinkMTUAct.value.length !=0) {
  if ( checkDigit(document.radvd.AdvLinkMTUAct.value) == 0) {
   alert("<% multilang("2393" "LANG_INVALID_ADVLINKMTU_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if ( lmtu != 0 && (lmtu < 1280 || lmtu > 1500) ) {
  alert("<% multilang("2394" "LANG_ADVLINKMTU_MUST_BE_EITHER_ZERO_OR_BETWEEN_1280_AND_1500"); %>");
  document.radvd.AdvLinkMTUAct.focus();
  return false;
 }
    if(document.radvd.EnableULA[1].checked){
  if (document.radvd.ULAPrefix.value =="") {
   alert("<% multilang("2395" "LANG_ULA_PREFIX_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_FC01"); %>");
   document.radvd.ULAPrefix.focus();
   return false;
  } else {
   if ( validateKeyV6IP(document.radvd.ULAPrefix.value) == 0) {
    alert("<% multilang("2396" "LANG_INVALID_ULA_PREFIX_IP"); %>");
    document.radvd.ULAPrefix.focus();
    return false;
   }
  }
    if (document.radvd.ULAPrefixlen.value =="") {
   alert("<% multilang("2397" "LANG_ULA_PREFIX_LENGTH_CANNOT_BE_EMPTY_FOR_EXAMPLE_64"); %>");
   document.radvd.ULAPrefixlen.focus();
   return false;
  } else {
   if ( checkDigit(document.radvd.ULAPrefixlen.value) == 0) {
    alert("<% multilang("2398" "LANG_INVALID_ULA_PREFIX_LENGTH_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
    document.radvd.ULAPrefixlen.focus();
    return false;
   }
  }
  if (document.radvd.ULAPrefixValidTime.value =="") {
   alert("<% multilang("2399" "LANG_ULA_PREFIX_VALID_TIME_CANNOT_BE_EMPTY_VALID_RANGE_IS_600_4294967295"); %>");
   document.radvd.ULAPrefixlen.focus();
   return false;
  } else if ( checkDigit(document.radvd.ULAPrefixValidTime.value) == 0) {
    alert("<% multilang("2400" "LANG_INVALID_ULAPREFIXVALIDTIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if (document.radvd.ULAPrefixPreferedTime.value =="") {
   ...
   return false;
    ...
    alert("<% multilang("2401" "LANG_INVALID_ULAPREFIXPREFEREDTIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 if (document.radvd.PrefixMode.value == 1) {
  if (document.radvd.prefix_ip.value =="") {
   alert("<% multilang("2402" "LANG_PREFIX_IP_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_3FFE_501_FFFF_100"); %>");
   ...
   if ( validateKeyV6IP(document.radvd.prefix_ip.value) == 0) {
    alert("<% multilang("2403" "LANG_INVALID_PREFIX_IP"); %>");
    document.radvd.prefix_ip.focus();
    return false;
   }
  }
  if (document.radvd.prefix_len.value =="") {
   alert("<% multilang("2404" "LANG_PREFIX_LENGTH_CANNOT_BE_EMPTY"); %>");
   ...
   if ( checkDigit(document.radvd.prefix_len.value) == 0) {
    alert("<% multilang("2405" "LANG_INVALID_PREFIX_LENGTH_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
    document.radvd.prefix_len.focus();
    return false;
   }
  }
  if (document.radvd.AdvValidLifetimeAct.value.length !=0) {
   if ( checkDigit(document.radvd.AdvValidLifetimeAct.value) == 0) {
    alert("<% multilang("2406" "LANG_INVALID_ADVVALIDLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if (document.radvd.AdvPreferredLifetimeAct.value.length !=0) {
   if ( checkDigit(document.radvd.AdvPreferredLifetimeAct.value) == 0) {
    alert("<% multilang("2407" "LANG_INVALID_ADVPREFERREDLIFETIME_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
  ...
  if ( vlt <= plt ) {
   alert("<% multilang("2408" "LANG_ADVVALIDLIFETIME_MUST_BE_GREATER_THAN_ADVPREFERREDLIFETIME"); %>");
   document.radvd.AdvValidLifetimeAct.focus();
   return false;
  }
 }
  if (document.radvd.RDNSS1.value !="") {
   if ( validateKeyV6IP(document.radvd.RDNSS1.value) == 0) {
    alert("<% multilang("2409" "LANG_INVALID_RDNSS1_IP"); %>");
  ...
  if (document.radvd.RDNSS2.value !="") {
   if ( validateKeyV6IP(document.radvd.RDNSS2.value) == 0) {
    alert("<% multilang("2410" "LANG_INVALID_RDNSS2_IP"); %>");
...
function updateInput()
{
 if (APShow == 1) {
  if (document.getElementById)
   document.getElementById('raenableID').style.display = 'block';
   else {
   if (document.layers == false)
    document.all.raenableID.style.display = 'block';
  }
 } else {
  if (document.getElementById)
   document.getElementById('raenableID').style.display = 'none';
  else {
   if (document.layers == false)
    document.all.raenableID.style.display = 'none';
  }
 }
}
...
<div class="intro_main ">
 <p class="intro_title">RADVD <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content" <% multilang("459" "LANG_THIS_PAGE_IS_USED_TO_SETUP_THE_RADVD_S_CONFIGURATION_OF_YOUR_DEVICE"); %></p>
</div>
<form action=/boaform/formRadvdSetup method=POST name="radvd">
<div class="data_common data_common_notitle">
<div ID="raenableID" style="display:none" class="data_common data_common_notitle">
 <table>
  <tr>
       <th width="30%"><% multilang("1192" "LANG_RADVD"); %><% multilang("174" "LANG_ENABLED"); %>:</th>
       <td width="70%">
         <input type="radio" name="radvd_enable" value=0 <% checkWrite("radvd_enable0"); %>><% multilang("485" "LANG_OFF"); %>&nbsp;&nbsp;
         <input type="radio" name="radvd_enable" value=1 <% checkWrite("radvd_enable1"); %>><% multilang("484" "LANG_ON"); %>&nbsp;&nbsp;
      </td>
    </tr>
</table>
</div>
<table>
  <tr>
   <th width="30%"><% multilang("460" "LANG_MAXRTRADVINTERVAL"); %>:</th>
   <td width="70%"><input type="text" name="MaxRtrAdvIntervalAct" size="15" maxlength="15" value=<% getInfo("V6MaxRtrAdvInterval"); %>></td>
  </tr>
  <tr>
   <th width="30%"><% multilang("461" "LANG_MINRTRADVINTERVAL"); %>:</th>
   <td width="70%"><input type="text" name="MinRtrAdvIntervalAct" size="15" maxlength="15" value=<% getInfo("V6MinRtrAdvInterval"); %>></td>
  </tr>
  <tr>
   <th><% multilang("468" "LANG_ADVMANAGEDFLAG"); %>:&nbsp;&nbsp;</th>
   <td>
    <input type="radio" name="AdvManagedFlagAct" value=0 <% checkWrite("radvd_ManagedFlag0"); %>><% multilang("485" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="AdvManagedFlagAct" value=1 <% checkWrite("radvd_ManagedFlag1"); %>><% multilang("484" "LANG_ON"); %>&nbsp;&nbsp;
   </td>
  </tr>
  <tr>
   <th><% multilang("469" "LANG_ADVOTHERCONFIGFLAG"); %>:&nbsp;&nbsp;</th>
   <td>
    <input type="radio" name="AdvOtherConfigFlagAct" value=0 <% checkWrite("radvd_OtherConfigFlag0"); %>><% multilang("485" "LANG_OFF"); %>&nbsp;&nbsp;
    <input type="radio" name="AdvOtherConfigFlagAct" value=1 <% checkWrite("radvd_OtherConfigFlag1"); %>><% multilang("484" "LANG_ON"); %>&nbsp;&nbsp;
   </td>
  </tr>
 </table>
</div>
...
<div ID="prefixModeDiv" style="display:none" class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%"><% multilang("470" "LANG_PREFIX_MODE"); %>:</th>
   <td>
    <select size="1" name="PrefixMode" id="prefixmode" onChange="ramodechange(this)">
     <OPTION VALUE="0" > <% multilang("176" "LANG_AUTO"); %></OPTION>
     <OPTION VALUE="1" > <% multilang("471" "LANG_MANUAL"); %></OPTION>
    </select>
   </td>
  </tr>
 </table>
...
<div ID="radvdID" style="display:none" class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th><% multilang("476" "LANG_ADVAUTONOMOUS"); %>:</th>
   <td>
...
<div ID="ULAdiv" style="display:none" class="data_common data_common_notitle">
  <table>
   <tr>
    <th width="30%"><% multilang("477" "LANG_ENABLE_ULA"); %>:</th>
    <td>
     <input type="radio" name="EnableULA" value=0 <% checkWrite("radvd_EnableULAFlag0"); %> onClick="ULASelection();"><% multilang("485" "LANG_OFF"); %>
     <input type="radio" name="EnableULA" value=1 <% checkWrite("radvd_EnableULAFlag1"); %> onClick="ULASelection();"><% multilang("484" "LANG_ON"); %>
    </td>
   </tr>
  </table>
</div>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" onClick="return saveChanges()">&nbsp;&nbsp;
