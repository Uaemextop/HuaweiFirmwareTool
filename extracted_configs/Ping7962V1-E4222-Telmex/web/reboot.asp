...
function saveClick()
{
   if ( !confirm('<% multilang("2574" "LANG_DO_YOU_REALLY_WANT_TO_COMMIT_THE_CURRENT_SETTINGS"); %>') ) {
 return false;
  }
  else{
...
function resetClick()
{
   if ( !confirm('<% multilang("2575" "LANG_DO_YOU_REALLY_WANT_TO_RESET_THE_CURRENT_SETTINGS_TO_DEFAULT"); %>') ) {
 return false;
  }
  else
 return true;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("543" "LANG_COMMIT_AND_REBOOT"); %></p>
