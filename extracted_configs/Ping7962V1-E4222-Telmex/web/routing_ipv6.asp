<%SendWebHeadStr(); %>
<title><% multilang("38" "LANG_ROUTING"); %><% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
function addClick(obj)
{
 if ( validateKeyV6IP( document.route.destNet.value ) == 0 ) {
           ...
           {
    alert("<% multilang("2432" "LANG_DESTNET_IS_NOT_VALID_IPV6_NET"); %>");
 ...
 if (document.route.nextHop.value!="") {
  ...
  else
  {
   if (! isGlobalIpv6Address( document.route.nextHop.value) ){
    alert("<% multilang("2434" "LANG_NEXTHOP_IS_NOT_VALID_GLOBAL_AND_UNICAST_IPV6_ADDRESS"); %>");
    document.route.nextHop.focus();
    return false;
   }
  }
 ...
 if ( !checkDigitRange(document.route.metric.value,1,0,16) ) {
  alert("<% multilang("2431" "LANG_INVALID_METRIC_RANGE_IT_SHOULD_BE_0_16"); %>");
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("5" "LANG_IPV6"); %> <% multilang("487" "LANG_STATIC"); %> <% multilang("38" "LANG_ROUTING"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"><% multilang("486" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_IPV6_STATIC_ROUTING_INFORMATION_HERE_YOU_CAN_ADD_DELETE_STATIC_IP_ROUTES"); %></p>
</div>
...
<div class="btn_ctl">
  <input class="link_bg" type="submit" value="<% multilang("451" "LANG_ADD_ROUTE"); %>" name="addV6Route" onClick="return addClick(this)">&nbsp;&nbsp;
  <input class="link_bg" type="submit" value="<% multilang("452" "LANG_UPDATE"); %>" name="updateV6Route" onClick="return addClick(this)">&nbsp;&nbsp;
  <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delV6Route" onClick="return deleteClick(this)">&nbsp;&nbsp;
  <input class="link_bg" type="submit" value="<% multilang("232" "LANG_DELETE_ALL"); %>" name="delAllV6Route" onClick="return deleteAllClick(this)">&nbsp;&nbsp;
  <input class="link_bg" type="button" value="<% multilang("453" "LANG_SHOW_ROUTES"); %>" name="showV6Route" onClick="routeClick('/routetbl_ipv6.asp')">
</div>
<div class="data_common data_common_notitle">
<table>
  <% showIPv6StaticRoute(); %>
