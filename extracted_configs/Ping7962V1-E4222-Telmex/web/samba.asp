<% SendWebHeadStr();%>
<title>Samba<% multilang("245" "LANG_CONFIGURATION"); %></title>
...
<div class="intro_main ">
 ...
 <p class="intro_content"><% multilang("1162" "LANG_THIS_PAGE_LET_USER_TO_CONFIG_SAMBA"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td width=60%>
    <input type="radio" value="0" name="sambaCap" onClick="changeSambaCap();" <% checkWrite("samba-cap0"); %>><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="sambaCap" onClick="changeSambaCap();" <% checkWrite("samba-cap1"); %>><% multilang("255" "LANG_ENABLE"); %>
   </td>
  </tr>
  <% checkWrite("smbSecurity"); %>
  <tbody id="conf">
   <tr <% checkWrite("nmbd-cap"); %>>
    <th width=40%>NetBIOS <% multilang("700" "LANG_NAME"); %>&nbsp;:</td>
    <td width=60%><input type="text" name="netBIOSName" maxlength="15"><td>
   </tr>
   <tr>
    <th width=40%><% multilang("1163" "LANG_SERVER_STRING"); %>&nbsp;:</td>
