...
{
 if(confirm("<% multilang("2576" "LANG_DO_YOU_REALLY_WANT_TO_RESET_THE_CURRENT_SETTINGS_TO_FACTORY_DEFAULT"); %>"))
 {
  obj.isclick = 1;
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td width="60%">
    <input class="inner_btn" type="submit" value="<% multilang("229" "LANG_RESET"); %>" name="reset" onclick="return resetClick(this)">
