<% SendWebHeadStr();%>
<title>SNMP <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
function saveChanges(obj)
{
 ...
 alert("<% multilang("2441" "LANG_INVALID_OBJECT_ID_VALUE_IT_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
 ...
 str = str.substring(1);
  ...
  if ( i!=6 ) {
   alert("<% multilang("2442" "LANG_INVALID_OBJECT_ID_VALUE_IT_SHOULD_BE_FILL_WITH_OID_STRING_AS_1_3_6_1_4_1_X"); %>");
   document.snmpTable.snmpSysObjectID.value = document.snmpTable.snmpSysObjectID.defaultValue;
 document.snmpTable.snmpSysObjectID.focus();
   return false;
  }
...
<div class="intro_main ">
 <p class="intro_title">SNMP <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"><% multilang("775" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_SNMP_HERE_YOU_MAY_CHANGE_THE_SETTINGS_FOR_SYSTEM_DESCRIPTION_TRAP_IP_ADDRESS_COMMUNITY_NAME_ETC"); %></p>
</div>
