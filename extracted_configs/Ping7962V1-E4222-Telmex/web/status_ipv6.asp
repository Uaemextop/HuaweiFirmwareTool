...
<div class="intro_main ">
 ...
 <p class="intro_content"><% multilang("103" "LANG_THIS_PAGE_SHOWS_THE_CURRENT_SYSTEM_STATUS_OF_IPV6"); %></p>
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left" ></div>
   <p><% multilang("6" "LANG_LAN"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
 <table>
  <tr>
   <th width=40%><% multilang("104" "LANG_IPV6_ADDRESS"); %></td>
   <td width=60%><% getInfo("ip6_global"); %></td>
   </tr>
  <tr>
   <th width=40%><% multilang("105" "LANG_IPV6_LINK_LOCAL_ADDRESS"); %></td>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("106" "LANG_PREFIX_DELEGATION"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
   <tr>
    <th width=40%><% multilang("107" "LANG_PREFIX"); %></td>
...
<form action=/boaform/admin/formStatus method=POST name="status_ipv6">
 <div class="column">
  <div class="column_title">
   <div class="column_title_left"></div>
    <p><% multilang("11" "LANG_WAN"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
   <div class="column_title_right"></div>
  </div>
