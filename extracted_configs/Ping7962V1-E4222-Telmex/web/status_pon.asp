...
<div class="intro_main ">
 ...
 <p class="intro_content"><% multilang("108" "LANG_PAGE_DESC_PON_STATUS"); %></p>
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("1272" "LANG_PON"); %><% multilang("109" "LANG_STATUS_1"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
   <tr>
    <th width=40%><% multilang("110" "LANG_VENDOR_NAME"); %></th>
    <td width=60%><% ponGetStatus("vendor-name"); %></td>
   </tr>
   <tr>
    <th width=40%><% multilang("111" "LANG_PART_NUMBER"); %></th>
    <td width=60%><% ponGetStatus("part-number"); %></td>
   </tr>
   <tr>
    <th width=40%><% multilang("112" "LANG_TEMPERATURE"); %></th>
    <td width=60%><% ponGetStatus("temperature"); %></td>
   </tr>
   <tr>
    <th width=40%><% multilang("113" "LANG_VOLTAGE"); %></th>
    <td width=60%><% ponGetStatus("voltage"); %></td>
   </tr>
   <tr>
    <th width=40%><% multilang("114" "LANG_TX_POWER"); %></th>
    <td width=60%><% ponGetStatus("tx-power"); %></td>
   <tr>
    <th width=40%><% multilang("115" "LANG_RX_POWER"); %></th>
    <td width=60%><% ponGetStatus("rx-power"); %></td>
   </tr>
   <tr >
    <th width=40%><% multilang("116" "LANG_BIAS_CURRENT"); %></th>
