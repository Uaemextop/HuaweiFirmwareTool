<% SendWebHeadStr();%>
<title><% multilang("117" "LANG_LAN_INTERFACE_SETTINGS"); %></title>
<SCRIPT>
function resetClick()
{
   ...
   lan_port_mask2.value = lpm2;
     ...
     if(RTKIPv6Enable == "yes")
     {
      if (ipv6_addr.value =="" || ipv6_addr.value =="::") {
       alert("<% multilang("2451" "LANG_LAN_IPV6_ADDRESS_CANNOT_BE_EMPTY_FORMAT_IS_IPV6_ADDRESS_FOR_EXAMPLE_3FFE_501_FFFF_100_1"); %>");
       ipv6_addr.focus();
       return false;
      } else {
       if ( validateKeyV6IP(ipv6_addr.value) == 0) {
        alert("<% multilang("2452" "LANG_INVALID_LAN_IPV6_IP"); %>");
        ipv6_addr.focus();
        return false;
       }
      }
            if ( ipv6landnsmode.value == 2 ){
       if(Ipv6Dns1.value == "" && Ipv6Dns2.value == "" )
       {
        Ipv6Dns1.focus();
        ...
        if(Ipv6Dns2.value != "" ){
         if (! isUnicastIpv6Address( Ipv6Dns2.value) ){
          ...
          else if ( validateKeyV6Prefix(lanIpv6prefix.value) == 0) {
...
<BODY onLoad="on_init();">
 <div class="intro_main ">
  <p class="intro_title"><% multilang("117" "LANG_LAN_INTERFACE_SETTINGS"); %></p>
  <p class="intro_content"><% multilang("118" "LANG_PAGE_DESC_CONFIG_DEVICE_LAN_INTERFACE"); %></p>
 </div>
 <form action=/boaform/formTcpipLanSetup method=POST name="tcpip">
  <div class="data_common data_common_notitle">
   <table>
    ...
    <tr>
      <th width="30%"><% multilang("70" "LANG_INTERFACE"); %><% multilang("700" "LANG_NAME"); %>:</th>
      <td width="70%">br0</td>
    </tr>
    <tr>
    ...
    <tbody id='ipv6_settings_div' style="display:none">
                  ...
                  <tr id='v6dns_Staic1' style="display:none">
                    <th width="30%"><% multilang("5" "LANG_IPV6"); %> <% multilang("855" "LANG_DNS1"); %>:&nbsp;&nbsp;</th>
                  ...
                  <tr id='v6dns_Staic2' style="display:none">
                        <th width="30%"><% multilang("5" "LANG_IPV6"); %> <% multilang("856" "LANG_DNS2"); %>:&nbsp;&nbsp;</th>
      ...
      <select name="ipv6lanprefixmode" onChange="prefixModeChange()">
                  ...
                  <tr id='v6delegated_WANConnection' style="display:none">
                    ...
                    <tr id="staticipv6prefix" style="display:none">
                      <th><% multilang("107" "LANG_PREFIX"); %>:&nbsp;&nbsp;</th>
