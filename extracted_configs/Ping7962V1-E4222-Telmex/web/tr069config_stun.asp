<% SendWebHeadStr();%>
<title>TR-069 <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
function resetClick()
{
...
function saveChanges(obj)
{
 ...
 alert("<% multilang("2455" "LANG_ACS_URL_CANNOT_BE_EMPTY"); %>");
 ...
 if (checkString(document.tr069.conreqpath.value) == 0) {
  alert("<% multilang("2458" "LANG_INVALID_PATH"); %>");
  document.tr069.conreqpath.focus();
  return false;
 }
  if (document.tr069.conreqport.value=="") {
 alert("<% multilang("2459" "LANG_PLEASE_INPUT_THE_PORT_NUMBER_FOR_CONNECTION_REQUEST_"); %>");
 ...
 alert("<% multilang("2460" "LANG_INVALID_PORT_NUMBER_OF_CONNECTION_REQUEST_IT_SHOULD_BE_1_65535"); %>");
 document.tr069.conreqport.value = document.tr069.conreqport.defaultValue;
 document.tr069.conreqport.focus();
 return false;
  }
...
<div class="intro_main ">
 <p class="intro_title">TR-069 <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("587" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_TR_069_CPE_HERE_YOU_MAY_CHANGE_THE_SETTING_FOR_THE_ACS_S_PARAMETERS"); %></p>
</div>
<form action=/boaform/formTR069Config method=POST name="tr069">
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%" style="font-weight: bold; font-size: 14"><% multilang("596" "LANG_TR069_DAEMON"); %>:</th>
   <td width="70%"><font size=2>
   <input type="radio" name=autoexec value=1 <% checkWrite("tr069-autoexec-1"); %> ><% multilang("185" "LANG_ENABLED"); %>&nbsp;&nbsp;
   <input type="radio" name=autoexec value=0 <% checkWrite("tr069-autoexec-0"); %> ><% multilang("186" "LANG_DISABLED"); %></font>
   </td>
  </tr>
  <tr>
   <th width="30%" style="font-weight: bold; font-size: 14"><% multilang("255" "LANG_ENABLE"); %>CWMP<% multilang("606" "LANG_PARAMETER"); %>:</th>
   <td width="70%"><font size=2>
   <input type="radio" name=enable_cwmp value=1 <% checkWrite("tr069-enable-cwmp-1"); %> ><% multilang("185" "LANG_ENABLED"); %>&nbsp;&nbsp;
   <input type="radio" name=enable_cwmp value=0 <% checkWrite("tr069-enable-cwmp-0"); %> ><% multilang("186" "LANG_DISABLED"); %></font>
   </td>
  </tr>
...
<table>
 <tr>
   <th width="30%"><% multilang("598" "LANG_URL"); %>:</th>
  <td width="70%"><input type="text" name="url" size="32" maxlength="256" value=<% getInfo("acs-url"); %>></td>
 </tr>
 <tr>
  <th width="30%"><% multilang("836" "LANG_USER"); %><% multilang("700" "LANG_NAME"); %>:</th>
 ...
 <tr>
  <th width="30%"><% multilang("588" "LANG_PERIODIC_INFORM"); %>:</th>
  <td width="70%">
  <input type="radio" name=enable value=0 <% checkWrite("tr069-inform-0"); %> onClick="return periodicSel()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=enable value=1 <% checkWrite("tr069-inform-1"); %> onClick="return periodicSel()"><% multilang("185" "LANG_ENABLED"); %>
  </td>
 </tr>
 <tr>
  <th width="30%"><% multilang("589" "LANG_PERIODIC_INFORM_INTERVAL"); %>:</th>
...
<div class="column clearfix">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p><% multilang("590" "LANG_CONNECTION_REQUEST"); %></p>
  <div class="column_title_right"></div>
 </div>
</div>
<div class="data_common">
...
<div class="column clearfix">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p><% multilang("600" "LANG_TR069_STUN_SETTING"); %></p>
  <div class="column_title_right"></div>
 </div>
</div>
<div class="data_common">
<table>
  <tr>
 <td width="30%"><font size=2><b><% multilang("599" "LANG_TR069_STUN"); %>:</b></td>
 <td width="70%"><font size=2>
 <input type="radio" name=stun_enable value=0 <% checkWrite("stun-0"); %> onClick="return StunSel()"><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;
 <input type="radio" name=stun_enable value=1 <% checkWrite("stun-1"); %> onClick="return StunSel()"><% multilang("185" "LANG_ENABLED"); %></font></td>
  </tr>
  <tr>
 <td width="30%"><font size=2><b><% multilang("599" "LANG_TR069_STUN"); %><% multilang("601" "LANG_TR069_STUN_SERVER"); %><% multilang("603" "LANG_TR069_STUN_SERVER_ADDRESS"); %>:</b></td>
 <td width="70%"><input type="text" name="stunsvraddr" size="32" maxlength="256" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-addr"); %>></td>
  </tr>
  <tr>
        <td width="30%"><font size=2><b><% multilang("599" "LANG_TR069_STUN"); %><% multilang("601" "LANG_TR069_STUN_SERVER"); %><% multilang("602" "LANG_TR069_STUN_SERVER_PORT"); %>:</b></td>
        <td width="70%"><input type="text" name="stunsvrport" size="32" maxlength="5" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-port"); %>></td>
  </tr>
  <tr>
 <td width="30%"><font size=2><b><% multilang("599" "LANG_TR069_STUN"); %><% multilang("601" "LANG_TR069_STUN_SERVER"); %><% multilang("604" "LANG_TR069_STUN_SERVER_USERNAME"); %>:</b></td>
 <td width="70%"><input type="text" name="stunsvruname" size="32" maxlength="256" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-uname"); %>></td>
  </tr>
  <tr>
        <td width="30%"><font size=2><b><% multilang("599" "LANG_TR069_STUN"); %><% multilang("601" "LANG_TR069_STUN_SERVER"); %><% multilang("605" "LANG_TR069_STUN_SERVER_USERPASSWD"); %>:</b></td>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="reset" value=<% multilang("343" "LANG_UNDO"); %> name="reset" onClick="resetClick()">
...
<div class="column clearfix">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p><% multilang("592" "LANG_CERTIFICATE_MANAGEMENT"); %></p>
  <div class="column_title_right"></div>
 </div>
</div>
<div class="data_common">
...
<table>
 <tr>
  <th width="30%"><% multilang("255" "LANG_ENABLE"); %> CWMP WAN ACL:</th>
  <td width="70%">
  <input type="radio" name=enable_acl value=1 <% checkWrite("tr069-enable-acl-1"); %> ><% multilang("185" "LANG_ENABLED"); %>&nbsp;&nbsp;
  <input type="radio" name=enable_acl value=0 <% checkWrite("tr069-enable-acl-0"); %> ><% multilang("186" "LANG_DISABLED"); %>&nbsp;&nbsp;&nbsp;&nbsp;
  <input class="inner_btn" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="applyACL" onClick="return on_submit(this)">&nbsp;&nbsp; </td>
 </tr>
 <tr>
...
<div class="btn_ctl">
 <td><input class="link_bg" type="submit" value="<% multilang("228" "LANG_ADD"); %>" name="addIP" onClick="return addClick(this)">&nbsp;&nbsp;</td>
</div>
<div class="column clearfix">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p>CWMP WAN ACL <% multilang("337" "LANG_TABLE"); %></p>
  <div class="column_title_right"></div>
 </div>
</div>
...
<div class="btn_ctl">
      <input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delIP" onClick="return deleteClick(this)">&nbsp;&nbsp;
      <input type="hidden" value="/tr069config_stun.asp" name="submit-url">
      <input type="hidden" name="postSecurityFlag" value="">
</div>
</form>
