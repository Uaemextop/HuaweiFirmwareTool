<% SendWebHeadStr();%>
<title>Tracert6 <% multilang("44" "LANG_DIAGNOSTICS"); %></title>
<script>
function on_Apply()
{
...
<div class="intro_main ">
 <p class="intro_title">Traceroute6 <% multilang("44" "LANG_DIAGNOSTICS"); %></p>
 <p class="intro_content"><% multilang("499" "LANG_PAGE_DESC_TRACERT6_DIAGNOSTIC"); %></p>
</div>
