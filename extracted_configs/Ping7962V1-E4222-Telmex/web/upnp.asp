<% SendWebHeadStr();%>
<title>UPnP <% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
<div class="intro_main ">
 <p class="intro_title">UPnP <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"><% multilang("434" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_UPNP_THE_SYSTEM_ACTS_AS_A_DAEMON_WHEN_YOU_ENABLE_IT_AND_SELECT_WAN_INTERFACE_UPSTREAM_THAT_WILL_USE_UPNP"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td>
    <input type="radio" value="0" name="daemon" <% checkWrite("upnp0"); %> onClick="proxySelection()"><% multilang("254" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="daemon" <% checkWrite("upnp1"); %> onClick="proxySelection()"><% multilang("255" "LANG_ENABLE"); %>
   </td>
  </tr>
