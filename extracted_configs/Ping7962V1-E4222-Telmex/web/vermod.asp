<%SendWebHeadStr(); %>
<title><% multilang("703" "LANG_VERSION"); %> </title>
<script>
...
function exportClick()
{
 ...
 alert('<% multilang("1106" "LANG_PAGE_DESC_WAIT_INFO"); %>!');
 return true;
}
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("703" "LANG_VERSION"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <td><input type="file" value="<% multilang("546" "LANG_CHOOSE_FILE"); %>" name="binary" size=20></td>
  </tr>
 </table>
</div>
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("561" "LANG_UPGRADE"); %>" onclick="return sendClicked()">&nbsp;&nbsp;
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=30%><% multilang("1104" "LANG_IMPORT"); %>:</th>
   <td width=30%><input class="inner_btn" type="file" value="<% multilang("546" "LANG_CHOOSE_FILE"); %>" name="binary" size=24></td>
   <td><input class="inner_btn" type="submit" value="<% multilang("1104" "LANG_IMPORT"); %>" name="load" onclick="return uploadClick()"></td>
  </tr>
 </table>
</div>
</form>
