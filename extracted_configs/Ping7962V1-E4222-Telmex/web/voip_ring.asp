...
<b><% multilang("1059" "LANG_RING_CADENCE_DETECTION_SETTING"); %></b>
...
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >
 <tr>
     <td bgColor=#aaddff width=155><% multilang("1060" "LANG_CADENCE"); %></td>
 ...
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Ring_Cad" value="<% multilang("341" "LANG_APPLY"); %>" onClick="return on_submit(this)">
    </td>
 </tr>
</table>
<!--
...
-->
<%voip_general_get("not_ipphone_option_start");%>
<b><% multilang("1061" "LANG_SELECT_CADENCE"); %></b>
<%voip_general_get("not_ipphone_option_end");%>
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >
 <tr>
     <td bgColor=#aaddff width=155><% multilang("1060" "LANG_CADENCE"); %></td>
...
<%voip_general_get("not_ipphone_option_start");%>
<b><% multilang("1062" "LANG_CUSTOM_CADENCE"); %></b>
<%voip_general_get("not_ipphone_option_end");%>
<table cellSpacing=1 cellPadding=2 border=0 width=325 <%voip_general_get("not_ipphone_table");%> >
 <tr>
     <td bgColor=#aaddff><% multilang("1063" "LANG_CADENCE_ON"); %> (<% multilang("953" "LANG_MSEC"); %>)</td>
     <td bgColor=#ddeeff>
  <input type=text name=cad_on size=20 maxlength=39 value="<%voip_ring_get("cad_on");%>"></td>
 </tr>
 <tr>
 <tr>
     <td bgColor=#aaddff><% multilang("1064" "LANG_CADENCE_OFF"); %> (<% multilang("953" "LANG_MSEC"); %>)</td>
     <td bgColor=#ddeeff>
 ...
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Ring_Cadence" value="<% multilang("341" "LANG_APPLY"); %>" onClick="return on_submit(this)" >
    </td>
 </tr>
</table>
