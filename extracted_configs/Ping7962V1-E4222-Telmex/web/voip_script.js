...
*/
	...
	postTableEncrypt(document.other_form.postSecurityFlag, document.other_form);	
	return true;
}
...
{
/*
    if (document.net_form.sipDscp.value != "0" && 
		!isNumeric(document.net_form.sipDscp.value, 0, 63))
	{
		alert('The SIP DSCP should be between 0~63.');
		document.net_form.sipDscp.select();
		document.net_form.sipDscp.focus();
		return false;
	}

    if (document.net_form.rtpDscp.value != "0" && 
        !isNumeric(document.net_form.rtpDscp.value, 0, 63))
    {
        alert('The RTP DSCP should be between 0~63.');
        document.net_form.rtpDscp.select();
        document.net_form.rtpDscp.focus();
        return false;
*/
/*
...
*/ 
	...
	postTableEncrypt(document.net_form.postSecurityFlag, document.net_form);
	return true;
}
