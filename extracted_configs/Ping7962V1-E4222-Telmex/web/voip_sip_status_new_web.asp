...
<form action="voip_sip_status_new_web.asp" method=get>
  ...
  <p class="intro_title"><% multilang("3016" "LANG_VOIP_REG_STATUS"); %></p>
  <p class="intro_content"><% multilang("3017" "LANG_VOIP_REG_STATUS_EXPLAIN"); %></p>
 </div>
    <br>
    <div class="column_title">
        <div class="column_title_left"></div>
        <p><% multilang("938" "LANG_REGISTER_STATUS"); %></p>
        <div class="column_title_right"></div>
    </div>
    <div class="data_common">
        <table>
            <tr>
                <td width="30%"><b><% multilang("220" "LANG_PORT"); %></b></td>
                <td width="40%"><b><% multilang("927" "LANG_NUMBER"); %></b></td>
