<%SendWebHeadStr(); %>
<title><% multilang("13" "LANG_DSL_WAN"); %> <% multilang("245" "LANG_CONFIGURATION"); %></title>
...
function vcCheck(obj)
{
 ...
 if (validateInt(document.adsl.vpi.value) == 0) {
  alert('<% multilang("2060" "LANG_INVALID_VPI_VALUE_VPI_SHOULD_NOT_BE_A_DECIMAL"); %>');
 ...
 if ( validateKey(document.adsl.vpi.value) == 0 ||
  ...
  alert('<% multilang("2061" "LANG_INVALID_VPI_VALUE_YOU_SHOULD_SET_A_VALUE_BETWEEN_0_255"); %>');
  document.adsl.vpi.focus();
  return false;
 }
 if (validateInt(document.adsl.vci.value) == 0) {
  alert('<% multilang("2062" "LANG_INVALID_VCI_VALUE_VCI_SHOULD_NOT_BE_A_DECIMAL"); %>');
 ...
 if ( validateKey(document.adsl.vci.value) == 0 ||
  ...
  alert('<% multilang("2063" "LANG_INVALID_VCI_VALUE_YOU_SHOULD_SET_A_VALUE_BETWEEN_0_65535"); %>');
  document.adsl.vci.focus();
  return false;
 }
 if ( (digitVPI == 0 && digitVCI == 0) ) {
  alert('<% multilang("2064" "LANG_INVALID_VPI_VCI_VALUE"); %>');
  document.adsl.vpi.focus();
  return false;
 }
 if (( document.adsl.adslConnectionMode.value == 2 ) ||
  ...
  if (document.adsl.adslConnectionMode.value != 0
   ...
   if (document.adsl.adslConnectionMode.value != 0 && document.adsl.adslConnectionMode.value != 8) {
    if(document.adsl.slacc.checked == false && document.adsl.itfenable.checked == false && document.adsl.staticIpv6.checked == false){
     alert('<% multilang("2044" "LANG_PLEASE_INPUT_IPV6_ADDRESS_OR_SELECT_DHCPV6_CLIENT_OR_CLICK_SLAAC"); %>');
...
function autopvcCheckClick(obj)
{
 ...
 if (document.adsl.autopvc.checked == true) {
  ...
  alert('<% multilang("2065" "LANG_YOU_SHOULD_ENABLE_AUTO_PVC_SEARCH_FIRST"); %>');
  return false;
 }
 obj.isclick = 1;
 postTableEncrypt(document.adsl.postSecurityFlag, document.adsl);
...
function apply1q()
{
 if (!check1q(document.adsl.vid.value)) {
  alert('<% multilang("2066" "LANG_INVALID_VLAN_ID"); %>');
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("13" "LANG_DSL_WAN"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("289" "LANG_PAGE_DESC_CONFIGURE_PARAMETERS"); %><% multilang("290" "LANG_WAN_MODE"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th><% multilang("95" "LANG_ENCAPSULATION"); %>: </th>
   <td>
  ...
  <tr>
   ...
   <td><input type="radio" value=1 name="chEnable" checked><% multilang("255" "LANG_ENABLE"); %>&nbsp;&nbsp;
    <input type="radio" value=0 name="chEnable"><% multilang("254" "LANG_DISABLE"); %></font>
   </td>
  </tr>
  <% ShowConnectionType() %>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="submit" value="<% multilang("338" "LANG_MODIFY"); %>" name="modify" onClick="return vcCheck(this)">
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("335" "LANG_CURRENT_ATM_VC_TABLE"); %></p>
...
<div class="btn_ctl">
<input class="link_bg" type="submit" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>" name="delvc" onClick="return deleteClick(this)">
</div>
<% ShowAutoPVC(); %>
