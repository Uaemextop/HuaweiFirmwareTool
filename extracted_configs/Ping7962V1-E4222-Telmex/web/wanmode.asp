<% SendWebHeadStr();%>
<title><% multilang("1160" "LANG_WAN_MODE_SELECTION"); %></title>
...
function SubmitWANMode(obj)
{
 ...
 if(confirm("<% multilang("2573" "LANG_IT_NEEDS_REBOOTING_TO_CHANGE_WAN_MODE"); %>"))
 {
  obj.isclick = 1;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("290" "LANG_WAN_MODE"); %></p>
 <p class="intro_content"><% multilang("1161" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_WHICH_WAN_TO_USE_OF_YOUR_ROUTER"); %></p>
</div>
<form action=/boaform/admin/formWanMode method=POST name="wanmode">
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="25%"><% multilang("290" "LANG_WAN_MODE"); %>:</th>
   <td>
