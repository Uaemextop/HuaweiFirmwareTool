<%SendWebHeadStr(); %>
<title><% multilang("1232" "LANG_WIRELESS_WAN"); %></title>
...
function on_linkchange(itlk)
{
 ...
 with ( document.forms[0] )
 {
  if(itlk == null)
  {
   ...
   naptEnabled.checked = igmpEnabled.checked = false;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("1232" "LANG_WIRELESS_WAN"); %></p>
 <p class="intro_content"> <% multilang("1233" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAPETERS_FOR_WIRELESS_WAN_OF_YOUR_ROUTER"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 ...
 <!--
  <tr>
   <td>
    <font size=2><b><% multilang("292" "LANG_ENABLE_VLAN"); %>: </b><input type="checkbox" name="vlan" size="2" maxlength="2" value="ON" onClick=vlanClicked()>
   </td>
  </tr>
  <tr>
   <td>
    <font size=2><b><% multilang("293" "LANG_VLAN"); %> ID: </b><input type="text" name="vid" size="10" maxlength="15">
   </td>
   <td><font size=2><b><% multilang("319" "LANG_802_1P_MARK"); %> </b>
...
<div class="btn_ctl">
 ...
 <!--<input type="submit" value="<% multilang("315" "LANG_DELETE"); %>" name="delete" onClick="return deleteCheck()"> -->
