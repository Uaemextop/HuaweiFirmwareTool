<%SendWebHeadStr(); %>
<title><% multilang("744" "LANG_WIRELESS_BAND_MODE"); %><% multilang("245" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
function on_submit()
{
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("744" "LANG_WIRELESS_BAND_MODE"); %> <% multilang("245" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("746" "LANG_THIS_PAGE_IS_USED_TO_SWITCH_802_11N_SINGLE_BAND_OR_DUAL_BAND_RADIO_FREQUENCY"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 ...
 -->
  <tr>
   <th><% multilang("747" "LANG_SIGNLE_BAND"); %>:</th>
   <td>
    <input type="radio" value="1" name="wlBandMode" onClick="" ></input>&nbsp;&nbsp;&nbsp;&nbsp;
    <% multilang("748" "LANG_THIS_MODE_CAN_SUPPORT_SINGLE_MODE_BY_2X2"); %>
   </td>
  </tr>
  <% checkWrite("onoff_dmdphy_comment_start"); %>
  <tr>
   <th><% multilang("749" "LANG_DUAL_BAND"); %>:</th>
   <td>
    <input type="radio" value="0" name="wlBandMode" onClick="" ></input>&nbsp;&nbsp;&nbsp;&nbsp;
    <% multilang("750" "LANG_THIS_MODE_CAN_SIMULTANEOUSLY_SUPPORT_802_11_A_B_G_N_WIRELESS_NETWORK_CONNECTION"); %>
   </td>
  </tr>
...
<div class="btn_ctl">
  ...
  <input class="link_bg" type="reset" value="<% multilang("229" "LANG_RESET"); %>" name="set" >
