<%SendWebHeadStr(); %>
<title><% multilang("1167" "LANG_FAST_BSS_TRANSITION_802_11R"); %></title>
<script>
var ssid_num;
...
function check_80211r_setting()
{
 ...
 if (len != 4) {
  alert("<% multilang("2514" "LANG_INVALID_MDID_2_OCTET_IDENTIFIER_AS_A_HEX_STRING"); %>");
  document.formFt.ft_mdid.focus();
  return false;
 }
 for (i=0; i<len; i++) {
  if (is_hex(document.formFt.ft_mdid.value.charAt(i)) == false) {
   alert("<% multilang("2515" "LANG_INVALID_HEX_NUMBER"); %>");
   document.formFt.ft_mdid.focus();
   return false;
  }
 }
 ...
 if (val>65535)
 {
  alert("<% multilang("2516" "LANG_INVALID_RANGE_OF_KEY_EXPIRATION_TIMEOUT_0_OR_1_65535_MINUTES"); %>");
 ...
 {
  alert("<% multilang("2517" "LANG_INVALID_RANGE_OF_REASSOCIATION_TIMEOUT_0_OR_1000_65535"); %>");
 ...
 if (len<1 || len>48)
 {
  alert("<% multilang("2518" "LANG_INVALID_NAS_IDENTIFIER_1_48_CHARACTERS"); %>");
...
function check_kh_setting(index)
{
 ...
 if (_ft_kh_num[index] >= <% checkWrite("11r_ftkh_num") %>) {
  alert("<% multilang("2519" "LANG_EXCEED_MAX_NUMBER_OF_KH_ENTRY_FOR_SELECTED_SSID"); %>");
  return false;
 }
 ...
 for (i=0; i<len; i++) {
  if (document.formFtKhAdd.kh_nas_id.value.charAt(i) == ' ') {
   alert("<% multilang("2520" "LANG_WHITE_SPACE_IS_NOT_ALLOWED_IN_NAS_IDENTIFIER_FIELD_"); %>");
   document.formFtKhAdd.kh_nas_id.focus();
   return false;
  }
 }
 ...
 if (len<1 || len>32)
 {
  alert("<% multilang("2521" "LANG_INVALID_KEY_LENGTH_SHOULD_BE_16_OCTETS_OR_1_32_CHARACTERS"); %>");
  document.formFtKhAdd.kh_nas_id.focus();
  return false;
 }
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("1167" "LANG_FAST_BSS_TRANSITION_802_11R"); %></p>
 <p class="intro_content"> <% multilang("1168" "LANG_THIS_PAGE_ALLOWS_YOU_TO_CHANGE_THE_SETTING_FOR_FAST_BSS_TRANSITION_802_11R"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
   <tr>
    <th><% multilang("144" "LANG_SSID"); %> <% multilang("300" "LANG_TYPE"); %>:</th>
    <td>
     <select name=ftSSID onChange="SSIDSelected( this.selectedIndex, this.form )"><% SSID_select(); %></select>
    </td>
   </tr>
   <tr>
    <th><% multilang("208" "LANG_ENCRYPTION"); %>:</th>
    <td>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr id="show_ft_enable">
   <th>
    <% multilang("1169" "LANG_IEEE_802_11R"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_mdid">
   <th>
    <% multilang("1170" "LANG_MOBILITY_DOMAIN_ID"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_over_ds">
   <th>
    <% multilang("1171" "LANG_SUPPORT_OVER_DS"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_res_request" style="display:none">
   <th>
    <% multilang("1172" "LANG_SUPPORT_RESOURCE_REQUEST"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_r0key_timeout">
   <th>
    <% multilang("1173" "LANG_KEY_EXPIRATION_TIMEOUT"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_reasoc_timeout">
   <th>
    <% multilang("1174" "LANG_REASSOCIATION_TIMEOUT"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_r0kh_id">
   <th>
    <% multilang("1140" "LANG_NAS_IDENTIFIER"); %>:
   </th>
   <td>
  ...
  <tr id="show_ft_push">
   <th>
    <% multilang("1175" "LANG_SUPPORT_KEY_PUSH"); %>:
   </th>
   <td>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="submit" name="ftSaveConfig" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" onclick="return check_80211r_setting()">
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("1176" "LANG_KEY_HOLDER_CONFIGURATION"); %></p>
...
<div class="btn_ctl">
 ...
 <input type="hidden" name="wlan_idx" value=<% checkWrite("wlan_idx"); %>>
 <input class="link_bg" type="submit" name="ftAddKH" value="<% multilang("228" "LANG_ADD"); %>"
  onClick="return check_kh_setting(ftSSID.selectedIndex)">&nbsp;&nbsp;
 <input class="link_bg" type="reset" name="reset" value="<% multilang("229" "LANG_RESET"); %>">&nbsp;&nbsp;
 <input type="hidden" name="postSecurityFlag" value="">
</div>
</form>
<!-- ----------------------------------------------------- -->
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("1177" "LANG_CURRENT_KEY_HOLDER_INFORMATION"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="submit" name="ftDelSelKh" value="<% multilang("231" "LANG_DELETE_SELECTED"); %>"
  onClick="return deleteClick(this)">&nbsp;&nbsp;
 <input class="link_bg" type="submit" name="ftDelAllKh" value="<% multilang("232" "LANG_DELETE_ALL"); %>"
