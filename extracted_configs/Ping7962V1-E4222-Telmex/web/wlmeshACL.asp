<%SendWebHeadStr(); %>
<title><% multilang("265" "LANG_WLAN_MESH_ACCESS_CONTROL"); %></title>
<script>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("265" "LANG_WLAN_MESH_ACCESS_CONTROL"); %></p>
 <p class="intro_content"> <% multilang("266" "LANG_PAGE_DESC_WLAN_MESH_ACCESS_CONTROL"); %></p>
</div>
 ...
 <table>
  <tr>
   ...
   <select size="1" name="wlanAcEnabled" onclick="updateState()">
     ...
     <td><input class="inner_btn" type="submit" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" name="setFilterMode" onClick="return on_submit(this)">&nbsp;&nbsp;</td>
  </tr>
 </table>
</div>
<div class="data_common data_common_notitle">
