<% SendWebHeadStr();%>
<title><% multilang("725" "LANG_WLAN_SITE_SURVEY"); %></title>
<script>
...
function saveClickSSID()
{
 ...
 if(document.getElementById("pocket_encrypt").value == "no"){
  ...
  if(document.getElementById("pocket_wpa2_tkip_aes").value.indexOf("aes")!=-1){
   ...
   alert("<% multilang("2523" "LANG_ERROR_NOT_SUPPORTED_WPA2_CIPHER_SUITE"); %>");
  }
 }
  ...
  if(document.getElementById("pocket_wpa_tkip_aes").value.indexOf("aes")!=-1){
   ...
   alert("<% multilang("2524" "LANG_ERROR_NOT_SUPPORTED_WPA_CIPHER_SUITE"); %>");
  }
 }
 else{
  alert("<% multilang("2525" "LANG_ERROR_NOT_SUPPORTED_ENCRYPT"); %>");
 }
 show_authentication();
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("725" "LANG_WLAN_SITE_SURVEY"); %></p>
 <p class="intro_content"><% multilang("726" "LANG_THIS_PAGE_PROVIDES_TOOL_TO_SCAN_THE_WIRELESS_NETWORK_IF_ANY_ACCESS_POINT_OR_IBSS_IS_FOUND_YOU_COULD_CHOOSE_TO_CONNECT_IT_MANUALLY_WHEN_CLIENT_MODE_IS_ENABLED"); %></p>
</div>
...
<div class="btn_ctl">
 <input type="submit" value="<% multilang("441" "LANG_REFRESH"); %>" name="refresh" onClick="return on_submit(this)" class="link_bg">&nbsp;&nbsp;
 <input type="button" value="<% multilang("1235" "LANG_NEXT_STEP"); %>" name="next" onClick="saveClickSSID()" class="link_bg">
</div>
</span>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th><% multilang("208" "LANG_ENCRYPTION"); %>:&nbsp;
  ...
  <tr id="enable_8021x" style="display:none">
   <th>802.1x <% multilang("209" "LANG_AUTHENTICATION"); %>:</th>
   <td>
    <input type="checkbox" id="use1x" name="use1x" value="ON" onClick="show_8021x_settings()">
   </td>
  </tr>
  <tr id="show_wep_auth" style="display:none">
   <th><% multilang("209" "LANG_AUTHENTICATION"); %>:</th>
   <td>
    <input name="auth_type" type=radio value="open" checked><% multilang("210" "LANG_OPEN_SYSTEM"); %>
  ...
  <table id="setting_wep" style="display:none">
   ...
   <tr>
    <th><% multilang("212" "LANG_KEY_LENGTH"); %>:</th>
    <td>
   ...
   <tr>
    <th><% multilang("213" "LANG_KEY_FORMAT"); %>:</th>
    <td>
 ...
 <table>
  <tr id="setting_wpa" style="display:none">
   <th><% multilang("215" "LANG_AUTHENTICATION_MODE"); %>:</th>
   <td>
  ...
  <tr id="show_wpa_cipher" style="display:none">
   <th>WPA <% multilang("216" "LANG_CIPHER_SUITE"); %>:</th>
   <td>
  ...
  <tr id="show_wpa2_cipher" style="display:none">
   <th>WPA2 <% multilang("216" "LANG_CIPHER_SUITE"); %>:</th>
   <td>
  ...
  <tr id="show_wpa_psk1" style="display:none">
   <th><% multilang("218" "LANG_PRE_SHARED_KEY_FORMAT"); %>:</th>
   <td>
  ...
  <tr id="show_wpa_psk2" style="display:none">
   <th><% multilang("219" "LANG_PRE_SHARED_KEY"); %>:</th>
 ...
 <table id="show_8021x_eap" style="display:none">
   ...
   <tr>
    <th>RADIUS <% multilang("91" "LANG_SERVER"); %> <% multilang("220" "LANG_PORT"); %>:</th>
 ...
 <table id="show_8021x_wapi" style="display:none">
   <tr id="show_8021x_wapi_local_as" style="">
    <th><% multilang("221" "LANG_USE_LOCAL_AS_SERVER"); %>:</th>
    <td>
...
<div class="btn_ctl">
 <input class="link_bg" type="button" value="<% multilang("1236" "LANG_BACK"); %>" name="back" onClick="return backClick()">
 <input class="link_bg" type="submit" value="<% multilang("99" "LANG_CONNECT"); %>" name="connect" onClick="return connectClick(this)">
