...
function postSecurity(encrypt, enable1X, wpaAuth, wpaPSKFormat, wpaPSK, wpaGroupRekeyTime, rsPort, rsIpAddr, rsPassword, rs2Port, rs2IpAddr, rs2Password, uCipher, wpa2uCipher, wepAuth, wepLen, wepKeyFormat, dotIeee80211w, sh256, wepKey, wepKey128)
{
...
<div id="wlan_security_table" style="display:none" class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th width="30%"><% multilang("144" "LANG_SSID"); %> <% multilang("300" "LANG_TYPE"); %>:</th>
   <td width="70%">
 ...
 <table id="setting_wpa" style="display:none">
  ...
  <tr id="show_wpa3_cipher" style="display:none">
   <th width="30%"><% multilang("216" "LANG_CIPHER_SUITE"); %>:</th>
   <td width="70%">
...
<div class="btn_ctl">
 ...
 <input type=submit name="save" value="<% multilang("159" "LANG_APPLY_CHANGES"); %>" onClick="return saveChanges(this)" class="link_bg">&nbsp;
