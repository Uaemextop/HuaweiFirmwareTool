<% SendWebHeadStr();%>
<title><% multilang("206" "LANG_WLAN_SECURITY_SETTINGS"); %></title>
<style>
.on {display:on}
.off {display:none}
.bggrey {
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("206" "LANG_WLAN_SECURITY_SETTINGS"); %></p>
 <p class="intro_content"> <% multilang("207" "LANG_PAGE_DESC_WLAN_SECURITY_SETTING"); %></p>
</div>
...
<table>
 ...
 <tr id="show_1x_wep" style="display:none">
  <th class="bgblue"><% multilang("212" "LANG_KEY_LENGTH"); %>:</th>
  <td>
 ...
 <div id="show_8021x_eap" style="display:none">
  ...
  <tr>
   <th class="bgblue">RADIUS <% multilang("91" "LANG_SERVER"); %> <% multilang("67" "LANG_PASSWORD"); %>:</th>
