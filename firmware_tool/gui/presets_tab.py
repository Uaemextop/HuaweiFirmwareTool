...
from firmware_tool.gui.constants import _safe_int
from firmware_tool.presets import PRESET_TEMPLATE
from firmware_tool.protocol import OBSC_SEND_PORT, OBSC_RECV_PORT
