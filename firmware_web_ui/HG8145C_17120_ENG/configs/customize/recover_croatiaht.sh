...
#customize.sh COMMON CROATIAHT  SSID  WPA密码 WEB普通用户密码 WEB管理员密码
...
HW_Script_SetDatToFile()
{
	...
	#set web admin pwd
	#WEB管理员密码为!tc0MhtSN(其中的SN为GPON SN，如GPON SN为4857544312345678，则WEB管理员密码为!tc0Mht4857544312345678
