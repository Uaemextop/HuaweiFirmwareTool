...
if ((('TELMEX' == CfgMode.toUpperCase()) || ('TELMEX5G' == CfgMode.toUpperCase()) || ('TELMEXACCESS' == CfgMode.toUpperCase())) && 'SPANISH' == curLanguage.toUpperCase())
{
    telmexSpan = true;
}
...
function InitTransmitPowerList(id)
{
	...
	if(1 == TelMexFlag)
	{
        ArrayTransmitPower = new Array(["100","100%"], ["75","75%"], ["50","50%"], ["25","25%"]);
	}else
	{
        ArrayTransmitPower = new Array(["100","100%"], ["80","80%"], ["60","60%"], 
        						["40","40%"], ["20","20%"]);
	}
...
{   
    ...
    for (i = 0; i < WlanMap.length; i++)
    {
        ...
        {
        	if (TextTranslate(Wlan[WlanMap[i].index].ssid) == ssid)
            {
    ...
    {
        if (isPlusInteger(getValue('X_HW_AssociateNum')) == false
