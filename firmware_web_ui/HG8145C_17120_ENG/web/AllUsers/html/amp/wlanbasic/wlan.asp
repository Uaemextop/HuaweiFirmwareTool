...
function isValidRadiusPort(port) 
{ 
...
function addAuthModeOption()
{
    ...
    if (mode == "11n")
    {
        document.forms[0].wlAuthMode[0] = new Option(cfg_wlancfgdetail_language['amp_auth_open'], "open");        
        document.forms[0].wlAuthMode[1] = new Option(cfg_wlancfgdetail_language['amp_auth_wpapsk'], "wpa-psk");
        document.forms[0].wlAuthMode[2] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa2psk'], "wpa2-psk");
        document.forms[0].wlAuthMode[3] = new Option(cfg_wlancfgdetail_language['amp_auth_wpawpa2psk'], "wpa/wpa2-psk");
        document.forms[0].wlAuthMode[4] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa'], "wpa");
        document.forms[0].wlAuthMode[5] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa2'], "wpa2");
        document.forms[0].wlAuthMode[6] = new Option(cfg_wlancfgdetail_language['amp_auth_wpawpa2'], "wpa/wpa2");
    }
    else
    {
        document.forms[0].wlAuthMode[0] = new Option(cfg_wlancfgdetail_language['amp_auth_open'], "open");
        document.forms[0].wlAuthMode[1] = new Option(cfg_wlancfgdetail_language['amp_auth_shared'], "shared");
        document.forms[0].wlAuthMode[2] = new Option(cfg_wlancfgdetail_language['amp_auth_wpapsk'], "wpa-psk");
        document.forms[0].wlAuthMode[3] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa2psk'], "wpa2-psk");
        document.forms[0].wlAuthMode[4] = new Option(cfg_wlancfgdetail_language['amp_auth_wpawpa2psk'], "wpa/wpa2-psk");
        document.forms[0].wlAuthMode[5] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa'], "wpa");
        document.forms[0].wlAuthMode[6] = new Option(cfg_wlancfgdetail_language['amp_auth_wpa2'], "wpa2");
        document.forms[0].wlAuthMode[7] = new Option(cfg_wlancfgdetail_language['amp_auth_wpawpa2'], "wpa/wpa2");
        if(1 == WapiFlag)
        {
            document.forms[0].wlAuthMode[8] = new Option(cfg_wlancfgdetail_language['amp_auth_wapi_psk'], "wapi-psk");
            document.forms[0].wlAuthMode[9] = new Option(cfg_wlancfgdetail_language['amp_auth_wapi'], "wapi");
        }
    }
...
{
    if((true == IsWpsConfigDisplay()) && 1 == getCheckVal('wlWPSEnable'))
    {
        setCheck('wlHide',1);
        setDisable('wlHide', 1);
    }
    ...
    if((true == IsWpsConfigDisplay()) && 0 == getCheckVal('wlHide'))
    {
...
{
    if(0 == getCheckVal('wlHide') && (true == IsWpsConfigDisplay()))
    {
        setDisable('wlWPSEnable', 1); 
    }
    else
...
{   
    ...
    for (i = 0; i < Wlan.length; i++)
    {
        if (ssidIdx != i)
        {
            if (TextTranslate(Wlan[i].ssid) == ssid)
            {
    ...
    if( ((curWebFrame == 'frame_CTCOM') && ('CMCC' != CfgMode.toUpperCase()) && ('JSCMCC' != CfgMode.toUpperCase())) 
    ...
    var deviceNum = parseInt(getValue('X_HW_AssociateNum'),10);
    ...
    Form.addParameter('y.X_HW_AssociateNum',deviceNum);
}
...
function addParameter2(Form)
{
    ...
    else if (AuthMode == 'wpa' || AuthMode == 'wpa2' || AuthMode == 'wpa/wpa2')
    {
        ...
        if (wlRadiusIPAddr == '' || wlRadiusPort == '' || wlWpaGtkRekey == '')
        {
        ...
        if (isValidRadiusPort(parseInt(wlRadiusPort,10)) == false)
        {
            AlertEx(cfg_wlancfgdetail_language['amp_srvport_invalid']);
            return false;
        }

        if (isInteger(wlWpaGtkRekey) == false)
        {
        	...
        	if (IsWpsConfigDisplay() != false)
        	{
	            ...
	            if (clientPinNum == '')
	            {
	             ...
	             if (isInteger(clientPinNum) == false)
	             {
	              ...
	              Form.addParameter('z.DevicePassword',parseInt(pinNum));
                }
        }
        else
        {
...
function setControl(idIndex)
{
    ...
    if ((((idIndex != 0) && (curWebFrame == 'frame_CMCC')) || (1 == gzcmccFlag)) && (curUserType == sptUserType))
    {
        setDisable('btnApplySubmit', 1);
        setDisable('cancel', 1);
    }
...
{        
    if (enbl == 1)
    {
        ...
        if ((WlanWifi.mode == "11b") || (WlanWifi.mode == "11g") || (WlanWifi.mode == "11bg"))
        {
            var len = document.forms[0].channelWidth.options.length;
            for (i = 0; i < len; i++)
            {
...
function CheckForm(type)
{
    ...
    if (getCheckVal('advanceEnbl') == 1)
    {
        ...
        if(!isPlusInteger(fragThreshold))
        {
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg" id="wlanInst">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        {   
            ...
            document.write('<TD>' + GetSSIDStringContent(Wlan[mapIndex].ssid,32)+ '</TD>');
                ...
                <tr>
                    ...
                    <td class="table_right" id="TdAuth">
                        <select id='wlAuthMode' name='wlAuthMode' size="1" onChange='authModeChange()' class="width_150px">
                          ...
                          if(1 == WapiFlag)
                          {
                                   <option value="wapi-psk"><script>document.write(cfg_wlancfgdetail_language['amp_auth_wapi_psk']);</script></option>
                                <option value="wapi"><script>document.write(cfg_wlancfgdetail_language['amp_auth_wapi']);</script></option>
                          }
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg">
                ...
                <tr>
                    <td class="table_title width_per25" BindText='amp_encrypt_key1'></td>
                        ...
                        if(g_keys[0] != null)
                        {
                            document.write("<input type='password' id='wlKeys1' name='wlKeys1' size='20' maxlength=26 onchange=\"wep1password=getValue('wlKeys1');getElById('twlKeys1').value=wep1password\" value='" + g_keys[0][1] + "'>")
                            document.write("<input type='text' id='twlKeys1' name='twlKeys1' size='20' maxlength=26 style='display:none'  onchange=\"wep1password=getValue('twlKeys1');getElById('wlKeys1').value=wep1password\" value='" + g_keys[0][1] + "'>");
                        }
                ...
                <tr>
                    <td class="table_title width_per25" BindText='amp_encrypt_key2'></td>
                        ...
                        if(g_keys[1] != null)
                        {
                            document.write("<input type='password' id='wlKeys2' name='wlKeys2' size='20' maxlength=26 onchange=\"wep2password=getValue('wlKeys2');getElById('twlKeys2').value=wep2password\" value='" + g_keys[1][1]+ "'>")
                            document.write("<input type='text' id='twlKeys2' name='twlKeys2' size='20' maxlength=26  style='display:none'  onchange=\"wep2password=getValue('twlKeys2');getElById('wlKeys2').value=wep2password\" value='" + g_keys[1][1] + "'>");
                        }
                ...
                <tr>
                    <td class="table_title width_per25" BindText='amp_encrypt_key3'></td>
                        ...
                        if(g_keys[2] != null)
                        {
                            document.write("<input type='password' id='wlKeys3' name='wlKeys3' size='20' maxlength=26 onchange=\"wep3password=getValue('wlKeys3');getElById('twlKeys3').value=wep3password\" value='" + g_keys[2][1] + "'>")
                            document.write("<input type='text' id='twlKeys3' name='twlKeys3' size='20' maxlength=26  style='display:none' onchange=\"wep3password=getValue('twlKeys3');getElById('wlKeys3').value=wep3password\" value='" + g_keys[2][1] + "'>");
                        }
                ...
                <tr>
                    <td class="table_title width_per25" BindText='amp_encrypt_key4'></td>
                        ...
                        if(g_keys[3] != null)
                        {
                            document.write("<input type='password' id='wlKeys4' name='wlKeys4' size='20' maxlength=26 onchange=\"wep4password=getValue('wlKeys4');getElById('twlKeys4').value=wep4password\" value='" + g_keys[3][1] + "'>")
                            document.write("<input type='text' id='twlKeys4' name='twlKeys4' size='20' maxlength=26  style='display:none' onchange=\"wep4password=getValue('twlKeys4');getElById('wlKeys4').value=wep4password\" value='" + g_keys[3][1] + "'>");
                        }
          ...
          <td class="table_right">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg">
                        <tr> 
                          ...
                          <td class="table_right" id="TdWPSEnable"> <input id='wlWPSEnable' name='wlWPSEnable' type='checkbox' value="ON" onClick="wlWPSEnableChange();"> 
                            <span class="gray"> </span></td>
                        </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr class="tabal_head">
        <td BindText='amp_wlan_advance'></td>
                    ...
                    <td  class="table_right"> <select id="wlTxPwr" name="wlTxPwr" class="width_150px">
                    ...
                    <td class="table_title width_per25" BindText='amp_channel_width'></td>
                            <td class="table_right">
                                <select id='channelWidth' name='channelWidth' size="1" onChange="ChannelWidthChange()" class="width_150px">
                                    <option value="0" selected><script>document.write(cfg_wlancfgadvance_language['amp_chlwidth_auto2040']);</script></option>
