...
{
	if ((('PTVDF' == CfgModeWord.toUpperCase())||('PTVDF2' == CfgModeWord.toUpperCase())) && curUserType == '0')
    {
    	return true;
    }
	else
...
{
	return ('TELMEXACCESS' == CfgModeWord.toUpperCase())? true : false;
}
...
function ShowInfo(MODE)
{
	...
	else
	{
		...
		document.write("<td class='table_right width_per25'>");
		document.write(algInfoArray[Index].Portocol + '</td>');
		document.write("<td class='table_right width_per15'>");
