...
<script language="JavaScript" type="text/javascript">
	...
	var ArpConfiglistInfo = new Array(new stTableTileInfo("Empty","","DomainBox"),
										...
										new stTableTileInfo("bbsp_mac","","macAddress"),null);
	InitTableData();
</script>
...
<form id='ConfigForm' style="display:none;">
	...
	<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg"> 
		<li   id="ipAddr"     RealType="TextBox"          DescRef="bbsp_ipmh"        RemarkRef="Empty"                ErrorMsgRef="Empty"    Require="TRUE"     BindField="x.IPAddress"   Elementclass="inputclass"  InitValue="Empty"/>
		<li   id="macAddr"    RealType="TextBox"          DescRef="bbsp_macmh"       RemarkRef="bbsp_macaddrform"     ErrorMsgRef="Empty"    Require="TRUE"     BindField="x.MACAddress"  Elementclass="inputclass"  InitValue="Empty"/>
	</table>
	<script language="JavaScript" type="text/javascript">
