...
var WanIPDdns = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.WANDevice.1.WANConnectionDevice.{i}.WANIPConnection.{i}.X_HW_DDNSConfiguration.{i},DDNSCfgEnabled|DDNSProvider|DDNSUsername|ServicePort|DDNSDomainName|DDNSHostName|SaltAddress,stDdns);%>;
var WanPPPDdns = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.WANDevice.1.WANConnectionDevice.{i}.WANPPPConnection.{i}.X_HW_DDNSConfiguration.{i},DDNSCfgEnabled|DDNSProvider|DDNSUsername|ServicePort|DDNSDomainName|DDNSHostName|SaltAddress,stDdns);%>;
...
function getDdnsEncryptAlgorithm(servProvider)
{
	...
	else if ((servProvider == 'other') && ((CfgModeWord == 'TRIPLET')||(CfgModeWord == 'TRIPLETVOICE')))
	{
		ret = 'MD5';
	}
	 ...
	 <table border="0" cellpadding="0" cellspacing="1"  width="100%"> 
		...
		<script language="JavaScript" type="text/javascript">
			...
			if (IsTriplet == 1)
			{
				...
				document.getElementById("DDNSDomainNameRemark").innerHTML = ddns_language['bbsp_domainmh_eg'];
				document.getElementById("SaltAddressRemark").innerHTML = ddns_language['bbsp_Salt_address_triplet'];
			}
		</script>
	  </table>
