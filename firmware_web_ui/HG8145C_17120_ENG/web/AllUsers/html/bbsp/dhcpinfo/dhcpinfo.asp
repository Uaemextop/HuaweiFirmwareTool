...
var SlaveDhcpInfos = <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_SpecParaSlaveDhcpPool,InternetGatewayDevice.X_HW_DHCPSLVSERVER,StartIP|EndIP|DHCPEnable,SlaveDhcpInfo);%>;  
...
<form id="ConfigForm"> 
<script language="JavaScript" type="text/javascript">
	HWCreatePageHeadInfo("dhcpinfotitle", GetDescFormArrayById(dhcpinfo_language, "bbsp_mune"), GetDescFormArrayById(dhcpinfo_language, ""), false);
...
<div class="title_spread"></div>
  ...
  <table class="tabal_noborder_bg" border="0" align="center" cellpadding="0" cellspacing="1" id='dhcpinfo' width="100%">  
    <tr> 
	...
	<script language="JavaScript" type="text/javascript"> 
		function FillDhcpInfo(info)
		{
			...
			for(i=0;i<info.length-1;i++)
			{
				...
				result += "<tr class='tabal_01 align_center'><td>"+GetStringContent(info[i].name, MAX_HOST_TYPE)+"</td>";
