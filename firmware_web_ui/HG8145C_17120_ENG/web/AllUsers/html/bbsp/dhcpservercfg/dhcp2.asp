...
function dhcpmainst(domain,enable,startip,endip,leasetime,l2relayenable,HGWstartip,HGWendip,STBstartip,STBendip,Camerastartip,Cameraendip,Computerstartip,Computerendip,Phonestartip,Phoneendip,MainDNS,X_HW_Option125Enable,DNSServers)
{
	this.domain 	= domain;
	this.enable		= enable;
...
<li   id="dhcpOption43"           RealType="TextBox"            DescRef="bbsp_op43mh"             RemarkRef="Empty"     		ErrorMsgRef="Empty"    Require="FALSE"     BindField="Empty"   Elementclass="TextBoxLtr"   InitValue="Empty"  TitleRef="bbsp_option43prnote"  MaxLength="63"/>
