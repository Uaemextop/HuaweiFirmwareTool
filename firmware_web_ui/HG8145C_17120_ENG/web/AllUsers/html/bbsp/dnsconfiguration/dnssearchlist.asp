...
.SelectDns
{
    ...
    {      
        ...
        for (i = 0; i < RecordCount; i++)
        {
            ...
            HtmlCode += '<TD class="restrict_dir_ltr" id = \"RecordWanName'+i+'\">' + GetWanFullName(Dns_Search_List[i].Interface) + '</TD>';
...
<div class="list_table_spread"></div>
	<table border="0" cellpadding="0" cellspacing="1"  width="100%">
		...
		<li   id="WanNameList"   RealType="DropDownList"     DescRef="bbsp_waninterfacemh"      RemarkRef="Empty"     ErrorMsgRef="Empty"    Require="FALSE"    BindField="x.Interface"    Elementclass="SelectDns"  InitValue="Empty"/>
