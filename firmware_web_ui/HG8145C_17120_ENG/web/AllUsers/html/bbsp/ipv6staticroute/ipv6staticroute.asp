...
<script language="JavaScript" type="text/javascript">
	...
	<form id="TableConfigInfo" style="display:none"> 
		<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg"> 
			...
			<li   id="WanNameList"            RealType="DropDownList"     DescRef="bbsp_wannamemh"      RemarkRef="Empty"     ErrorMsgRef="Empty"    Require="FALSE"    BindField="Empty"    Elementclass="width_260px restrict_dir_ltr"     InitValue="Empty"/>
			<script language="JavaScript" type="text/javascript">
				...
				if("1" == GetCfgMode().PCCWHK)
				{
					getElement('WanNameListspan').innerHTML = static_route_language['bbsp_interface_blank'];
				}
			</script>
		</table>
