...
function IsinWanList(domain)
{
    ...
    function BindPageData()
    {
        ...
        if ((SonetFlag == '1')  || ('TDE2' == CfgMode.toUpperCase()))
        {
...
function CtrlIPAddressRow(state)
{
	...
	if("Manual" != getValue("ResourceAllocModeList"))
	{
		flag = 0;
	}
...
function BindDHCPv6Info()
{
	...
	var newBr0IPv6Prefix = ParseBackIPv6Para(Br0IPv6Prefix.Prefix, 64);
...
<li id="WanNameList" RealType="DropDownList" DescRef="bbsp_parentPremh" RemarkRef="Empty" ErrorMsgRef="Empty" Require="FALSE" BindField="WanNameList" Elementclass="SelectLtr" InitValue="Empty" />
...
{
	document.getElementById('RAMXUColRemark').innerHTML = lan_address_language['bbsp_mturemark2'];
