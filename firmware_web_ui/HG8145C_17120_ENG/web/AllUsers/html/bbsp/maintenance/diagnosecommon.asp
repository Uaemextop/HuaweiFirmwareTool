...
<form id="table_ping" style="display:block;"> 
	...
	<script>
		...
		if ('PTVDF' == CfgModeWord.toUpperCase() || 'PTVDF2' == CfgModeWord.toUpperCase())
		{
			document.getElementById("IPAddressColleft").innerHTML = diagnose_language['bbsp_targetmh1'];
		}
		else
		{
		...
		{
			document.getElementById("NumOfRepetitionsRemark").innerHTML = diagnose_language['bbsp_repetitionsPrompt'];
		}
  ...
  <div id ="TraceRoute"> 
	...
	<form id="table_trace" style="display:block;"> 
		...
		<script>
			...
			if ('PTVDF' == CfgModeWord.toUpperCase() || 'PTVDF2' == CfgModeWord.toUpperCase())
			{
				document.getElementById("urladdressColleft").innerHTML = diagnose_language['bbsp_targetmh1'];
			}
			else
			{
