...
function IsRepeateVenderClassId(RouteInfo)
{
    ...
    for (k = 0; k < PolicyRouteList.length-1; k++)
    {
        ...
        OldVenderId = TextTranslate(PolicyRouteList[k].VenderClassId).split(',');        
...
<form id="TableConfigInfo" style="display:none">
	...
	<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg"> 
		...
		<li   id="WanNameList"      RealType="DropDownList"  DescRef="bbsp_wannamemh"          RemarkRef="Empty"     ErrorMsgRef="bbsp_proutermsg2"    Require="FALSE"    BindField="x.WanName"  Elementclass="width_260px restrict_dir_ltr"  InitValue="Empty"/>                                                                   
		<script>
