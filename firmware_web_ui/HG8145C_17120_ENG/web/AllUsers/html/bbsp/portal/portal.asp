...
<form id="TableUrlInfo" style="display:none"> 
	...
	<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg"> 
		...
		<li   id="UrlAddressControl"    RealType="TextBox"          DescRef="bbsp_urlmh"       RemarkRef="Empty"     ErrorMsgRef="Empty"    Require="TRUE"     BindField="x.PortalUrl"  Elementclass="inputclass"  InitValue="Empty" Maxlength="256"/>
	</table>
	<script language="JavaScript" type="text/javascript">
