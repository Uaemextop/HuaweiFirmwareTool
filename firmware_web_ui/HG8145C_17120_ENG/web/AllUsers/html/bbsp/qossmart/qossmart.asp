...
<form id="TableConfigInfo" style="display:none;"> 
 <div class="list_table_spread"></div>
	<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg"> 
		...
		<li   id="DSCPMark"                 RealType="TextBox"            DescRef="Empty"             RemarkRef="bbsp_DSCPrange"      ErrorMsgRef="Empty"    Require="TRUE"     BindField="x.DSCPMark"       Elementclass="width_260px"     InitValue="Empty"    MaxLength='2'  ClickFuncApp="onchange=Get802dot1pByDSCP"/>
		<li   id="PRIMark"                  RealType="TextBox"            DescRef="Empty"             RemarkRef="bbsp_dscprelation"   ErrorMsgRef="Empty"    Require="FALSE"    BindField="x.PRIMARK"        Elementclass="width_260px"     InitValue="Empty" />
	...
	<script language="JavaScript" type="text/javascript">
		...
		document.getElementById("ClassInterfaceColleft").innerHTML = appendPrompt('bbsp_qossmartclassinterface');
		document.getElementById("VLANIDCheckColleft").innerHTML = appendPrompt('bbsp_qossmartvlan');
		document.getElementById("ProtocolColleft").innerHTML = appendPrompt('bbsp_qossmartprotocol');
		document.getElementById("Protocol").title = qos_smart_language['bbsp_protocol_title'];
		document.getElementById("QosSmartDomainIdColleft").innerHTML = appendPrompt('bbsp_qossmartdomain');
		document.getElementById("QosSmartDomainIdRemark").innerHTML = qos_smart_language['bbsp_qossmartdomaintips'];
		document.getElementById("DestIPColleft").innerHTML = appendPrompt('bbsp_qossmartdestipmask');
		document.getElementById("SourceIPColleft").innerHTML = appendPrompt('bbsp_qossmartsrcipmask');
		document.getElementById("DestPortColleft").innerHTML = appendPrompt('bbsp_qossmartdestportrange');
		document.getElementById("SourcePortColleft").innerHTML = appendPrompt('bbsp_qossmartsrcportrange');
		document.getElementById("DSCPMarkColleft").innerHTML = appendPrompt('bbsp_qossmardscpmark');
		document.getElementById("PRIMarkColleft").innerHTML = appendPrompt('bbsp_qossmartpbitmark');
		document.getElementById("TcMarkColleft").innerHTML = appendPrompt('bbsp_qossmarttcmark');
		document.getElementById("ReMarkModeColleft").innerHTML = appendPrompt('bbsp_qossmartremarkmode');
		document.getElementById("TcReMarkColleft").innerHTML = appendPrompt('bbsp_qossmarttcremark');
		document.getElementById("TcPriMarkColleft").innerHTML = appendPrompt('bbsp_qossmartprimark');
	</script>
