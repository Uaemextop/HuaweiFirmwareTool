...
<script language="JavaScript" type="text/javascript">
	HWCreatePageHeadInfo("qossmartstattitle", GetDescFormArrayById(qos_smart_statistics_language, "bbsp_mune"), GetDescFormArrayById(qos_smart_statistics_language, "bbsp_qos_smart_statistics_title"), false);
</script> 
...
var QossmartConfiglistInfo = new Array(new stTableTileInfo("bbsp_CountEnable","align_center","DomainBox"),
									...
									new stTableTileInfo("bbsp_qossmartdestipmask","align_center restrict_dir_ltr","DestIPMask"),
									new stTableTileInfo("bbsp_qossmartsrcipmask","align_center restrict_dir_ltr","SourceIPMask"),
