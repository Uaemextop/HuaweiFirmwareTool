...
function shoulist(startlist , endlist, UserDevicesInfo)
{
	...
	for(i=startlist;i <= endlist - 1;i++)   
	{
		...
		outputlist = outputlist + appendstr('<td style="width:10%">'+hostport  +'</td>');
		outputlist = outputlist + appendstr('<td style="width:15%">'+GetStringContent(UserDevicesInfo[i].DevType, MAX_DEV_TYPE) +'</td>');
		...
		outputlist = outputlist + appendstr('<td style="width:20%">');
...
<div class="title_spread"></div>
  ...
  <table class='width_per100' border="0" align="center" cellpadding="0" cellspacing="1" id='devlist'>
	...
	<td class="per_13_16" BindText='bbsp_devport'></td> 
    <td class='per_13_15' BindText='bbsp_devtype'></td> 
    <td class="width_per18" BindText='bbsp_ip'></td> 
    <td class="width_per18" BindText='bbsp_mac'></td> 
