...
{ 	
	...
	document.getElementById('ProductVersion').innerHTML = CardCfgInfo.DataCardVendor;
	document.getElementById('SoftWareVersion').innerHTML = CardCfgInfo.DataCardSwVesion;
	document.getElementById('HardWareVersion').innerHTML = CardCfgInfo.DataCardHdVesion;
	...
	{	
		...
		else
		{
			if(CardCfgInfo.PinRemainTimes==0)
			{
				...
				document.getElementById('remaintimes').innerHTML = CardCfgInfo.PukRemainTimes;
			}
			else
			{
					if(CardCfgInfo.PinStates == 0)
					{
						...
						setDisplay('retryarea', 1);
						setDisplay('simsubmitnav', 1);
						document.getElementById('remaintimes').innerHTML = CardCfgInfo.PinRemainTimes;
					}
					else
					{
...
{
	if(value.length!=4 || !isValidNumber(value))
	{
		AlertEx(GetLanguageDesc("s2120"));
		return false;
	}
...
<div> 
  <table class="tabal_noborder_bg" width="100%" cellpadding="0" cellspacing="1"> 
	...
	<tr class="table_title"  id="pukcodearea" style="display:none"> 
	  ...
	  <td>   
	  <input type="password" name="pukword" id="pukword" maxlength="8">
	  </td> 
    </tr> 
	 ...
	 <tr class="table_title"  id="pincodearea" style="display:none"> 
	  ...
	  <td>   
	  <input type="password" name="pinword" id="pinword" maxlength="4">
	  </td> 
    </tr> 
	...
	<tr class="table_title"  id="oldpincodearea" style="display:none"> 
	  ...
	  <td>   
	  <input type="password" name="oldpinword" id="oldpinword" maxlength="4">
	  </td> 
    </tr> 
	<tr class="table_title"  id="newpincodearea" style="display:none"> 
	  ...
	  <td>   
	  <input type="password" name="newpinword" id="newpinword" maxlength="4">
	  </td> 
    </tr>
	<tr class="table_title"  id="confirmnewpin" style="display:none"> 
	  ...
	  <td>   
	  <input type="password" name="confirmpinword" id="confirmpinword" maxlength="4">
	  </td> 
    </tr>
	
	 <tr class="table_title" id="retryarea" style="display:none">  
      <td width="200px" BindText="s2119">  
	  </td> 
	  <td id="remaintimes">  
	  </td> 
    </tr> 
