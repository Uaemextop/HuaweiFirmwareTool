...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="Wizard1Panel" class="tabal_bg">
	<tr>
	<td class="table_title width_per25">PPPoE Username:</td>
	<td class="table_right width_per75"> <input type="text" id="pppoe_wan_name" maxlength="63"></td>
  </tr>
  <tr>
	<td class="table_title width_per25" >PPPoE Password:</td>
	<td class="table_right width_per75"> <input type="password" id="pppoe_wan_pwd" maxlength="63" > </td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
	<td class="table_title width_per25">WiFi Enabled</td>
	<td class="table_right width_per75"><input checked type='checkbox' id='Wizard_checkbox02_checkbox' name='Wizard_checkbox02_checkbox'></td>

	</tr>
	<tr>
		<td class="table_title width_per25">WiFi SSID:&nbsp;</td>
	...
	<tr>
		<td class="table_title width_per25">WiFi Password:&nbsp;</td>
		<td class="table_right width_per75">
...
<table id="internetinfo" width="100%" border="0" cellpadding="0" cellspacing="1" style="display:none" class="tabal_bg">
	...
	<td class="table_title width_per25">PPPoE Username</td>
	<td class="table_right width_per75" id="internet_user"></td>
	</tr>
	<tr id="tr_internet_pwd">
	<td class="table_title width_per25">PPPoE Password</td>
	<td class="table_right width_per75" id="internet_pwd"></td>
	</tr>
</table>

<table id="wlaninfo" width="100%" border="0" cellpadding="0" cellspacing="1" style="display:none" class="tabal_bg">
	<tr>
	<td class="table_title width_per25">WiFi Status</td>
	<td class="table_right width_per75" id="wlan_enable"></td>
	</tr>
	<tr >
	<td class="table_title width_per25">WiFi SSID</td>
	<td class="table_right width_per75" id="wlan_ssid"></td>
	</tr>
	<tr >
	<td class="table_title width_per25">WiFi Password</td>
	<td class="table_right width_per75" id="wlan_psk"></td>
	</tr>
</table>
