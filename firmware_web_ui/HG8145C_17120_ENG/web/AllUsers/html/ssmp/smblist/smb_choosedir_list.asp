...
<title>dir/usb/</title>
<script language="JavaScript" src="<%HW_WEB_CleanCache_Resource(jquery_mini.js);%>"></script>
<script language="JavaScript" src="../../../resource/common/<%HW_WEB_CleanCache_Resource(jquery_min.js);%>"></script>
<script language="JavaScript" src="<%HW_WEB_CleanCache_Resource(jquery_treeview.js);%>"></script>
...
/*AppendOthersFromAjax(fileflag, id, AjaxGetStr)
  fileflag  : whether support fileflag: 0--not support; 1--support
  id        : where the html append 
  AjaxGetStr: para from web server by ajax method
  ******************************************************************
  AppendFirstChildToBody(fileflag, id, AspNameStr)
  fileflag  : whether support fileflag: 0--not support; 1--support
  id        : where the html append 
  AspNameStr: para from web server by asp command
  ******************************************************************
  fileType:
           0: file
		   1: folder has no file
		   2: folder has files only
		   3: normal folder and can be expanded
  */
...
<link rel="stylesheet" href="<%HW_WEB_CleanCache_Resource(jquery_treeview.css);%>" type="text/css" />
</head>
<body>
  ...
  <tr>
	...
	<div id="BaseMask" style="display:none"></div>
      <table border="1" cellpadding="1" cellspacing="0" width="95%" style="background-color: #F0F0F0;">
       ...
       <p>&nbsp;</p>
		<div style="height:300px; width:560px; overflow-y:scroll;overflow-x:scroll; white-space:nowrap;" id="main">
		<ul id="browser" class="filetree" style="height:300px; margin-left:10px;">
		</ul>	
		</div>
      <p>&nbsp;</p>
      <table border="1" cellpadding="1" cellspacing="0" width="95%" style="background-color: #F0F0F0;">
