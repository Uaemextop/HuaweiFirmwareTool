...
{
	if (   UsbDevice[0] == null
		|| UsbDevice[0].DeviceList == null
		|| UsbDevice[0].DeviceList == '' )
	{
...
<body class="mainbody">
	...
	<script>
		//ParseBindTextByTagName(UsbstatusLgeDes, "div",    1);
		//ParseBindTextByTagName(UsbstatusLgeDes, "td",     1);
		//ParseBindTextByTagName(UsbstatusLgeDes, "input",  2);
	</script>
</body>
</html>
