...
<body class="mainbody" onLoad="LoadFrame();">
	...
	<form id="ConfigForm" action="">
		<table id="table_downloadinfo" width="100%" cellspacing="1" cellpadding="0">
			...
			<li id="LocalPath"    RealType="TextBox"      DescRef="s051e" RemarkRef="Empty" ErrorMsgRef="Empty" Require="FALSE" BindField="Empty" MaxLength="40"    ElementClass="UserInput" InitValue="Empty"/>
		</table>
		<script>
