  ...
  <tr>
	...
	<script language="javascript">
		...
		html += '<td id="LoopCurrentTestResultCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].LoopCurrentTestResult;
			 + '</td>';
		document.write(html);	 
	</script>
  </tr>
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="FeedTestResultCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].FeedTestResult;
			 + '</td>';
		document.write(html);	 
	</script>
  </tr>
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="RingTestResultCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].RingTestResult;
			 + '</td>';
		document.write(html);	 
	</script>
  </tr>
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="OnOffHookTestResultCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].OnOffHookTestResult;
			 + '</td>';
		document.write(html);	 
	</script>
  </tr>
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="LoopCurrentValueCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].LoopCurrentValue;
			 + '</td>';
		document.write(html);	 
	</script>
  </tr>
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="FeedValueCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].FeedValue;
			 + '</td>';
		document.write(html);	 
	</script> 
  </tr>  
  <tr>
	...
	<script language="javascript">
		...
		html += '<td  id="RingValueCell" class="table_right" width="70%"  align="left">'
		     + AllInnerLineResults[InnerSelValue-1].RingValue;
			 + '</td>';
		document.write(html);
	</script>
