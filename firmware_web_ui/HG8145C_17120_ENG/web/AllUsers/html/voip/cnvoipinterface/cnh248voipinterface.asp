...
{   
	...
	var MediaPortName=document.getElementById('MediaPortName');
        ...
        else
        {
            ...
            {
                if ( false == vspaisValidCfgStr(h248interface['vspa_theprimgc'],CallAgent1.value,256) )
                {                  
                    return false;       
                }
        ...
        if ( '' != removeSpaceTrim(CallAgent2.value))
        {
            ...
            {
                if ( false == vspaisValidCfgStr(h248interface['vspa_standbymgc'],CallAgent2.value,256) )
                {
                    return false;
                }
        ...
        {
            if (vspaisValidCfgStr(h248interface['vspa_themgdomain'],MGDomain.value,256) == false)
            {
                return false;
            }
        }
        ...
        {
            if (vspaisValidCfgStr(h248interface['vspa_thedevicename'],DeviceName.value,256) == false)
            {
                return false;
            }
        }
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
 ...
 <tr>
	...
	<td class="table_right align_left width_per75" colspan="2">
	 <input name="LineName" id="LineName" type="text" maxlength="256" style="width: 155px" />&nbsp;<strong style="color:#FF0033">*</strong>                    
	</td>
</tr> 
