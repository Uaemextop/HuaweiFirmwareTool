...
function SubmitRefreshVoiceQuality()
{
	...
	setLastestPhyIndexCookie('VoiceQualitySelect', PhyReferenceIndex);
	...
	<script type="text/javascript">
		...
		if (PotsAllVoiceQuality.length > 1)
		{
			for ( var k = 0; k < PotsAllVoiceQuality.length - 1; k++)
			{
				...
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].StatTime + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].TxPackets + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].RxPackets + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].MeanDelay + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].MeanJitter + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].FractionLoss + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].FarEndIPAddress + '</td>';																
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].MosLq/10 + '</td>';
				html += '<td class="align_left">' + PotsAllVoiceQuality[k].Codec + '</td>';
...
<div id="logviews"> 
  <textarea dir="ltr" name="logarea" id="logarea" class="text_log" wrap="off" readonly="readonly"><%HW_WEB_GetVoiceLogInfo();%>
  </textarea> 
	<script type="text/javascript">
