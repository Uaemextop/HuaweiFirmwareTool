...
function LoadFrame()
{
	...
	if((CfgMode.toUpperCase() == 'PTVDF')||(CfgMode.toUpperCase() == 'PTVDF2'))
    {
...
var ConfiglistInfo = new Array(
		...
		new stTableTileInfo("vspa_uri","uriclass align_center","URI",((CfgMode.toUpperCase() == 'PTVDF')||(CfgMode.toUpperCase() == 'PTVDF2'))),
