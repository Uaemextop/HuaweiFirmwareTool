	  ...
	  <script type="text/javascript">
            ...
            else
            {
                for (i = 0; i < AllLine.length - 1; i++)
                {
					...
					{
						html += '<td class="align_center" style="word-wrap:break-word; overflow:hidden;">' + User[i].UserId + '</td>'
					}  
					html += '<td class="align_center">' + '--' + '</td>'       
                          
                    html += '<td class="align_center">' + AllLine[i].PhyReferenceList+ '</td>'
						   + '<td class="align_center">' + AllLine[i].Status + '</td>'
                           + '<td class="align_center">' + AllLine[i].CallState + '</td>'    
                    ...
                    if(0 == i)
                    {
						...
						{
							html += '<td class="align_center" rowspan='+(AllLine.length-1)+'>' + InterfaceState[0].X_HW_InterfaceState + '</td>'   
						}                                                    
                    } 
			...
			else
			{
				for (i = 0; i < AllLine.length - 1; i++)
				{
					...
					{           
						document.write('<td class=\"align_center\" style=\"word-wrap:break-word; overflow:hidden;\">' + User[i].UserId + '</td>'); 
					}
					
					document.write('<td class=\"align_center\">' + '--' + '</td>' + 
					'<td class=\"align_center\" style=\"word-wrap:break-word; overflow:hidden;\">' + AllLine[i].PhyReferenceList+ '</td>');
					...
					if(0 == i)
					{	
						document.write('<td class=\"align_center\" rowspan='+(AllLine.length-1)+'>' + GetInterfaceState() + '</td>');	
					} 
