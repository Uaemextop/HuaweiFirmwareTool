...
{   
    ...
    if ( '' != removeSpaceTrim(getValue('OutboundProxy')))
    {
        ...
        {           
            if ( false == vspaisValidCfgStr(sipinterface['vspa_theoutproxy'], getValue('OutboundProxy'),256) )
            {                  
                return false;       
            }
        }
    ...
    if ( '' != removeSpaceTrim(getValue('SecondaryOutboundProxy')))
    {
        ...
        {           
            if ( false == vspaisValidCfgStr(sipinterface['vspa_thesecproxy'], getValue('SecondaryOutboundProxy'),256) )
            {                  
                return false;       
            }
        }
    ...
    if ( '' != removeSpaceTrim(getValue('ProxyServer')))
    {
        ...
        {           
            if ( false == vspaisValidCfgStr(sipinterface['vspa_thepriproxy'], getValue('ProxyServer'),256) )
            {                  
                return false;       
            }
        }
    ...
    if ( '' != removeSpaceTrim(getValue('SecondProxyServer')))
    {
        ...
        {
            if ( false == vspaisValidCfgStr(sipinterface['vspa_standbyproxy'],getValue('SecondProxyServer'),256) )
            {
                return false;
            }
	...
	if ( '' != removeSpaceTrim(getValue('HomeDomain')))
	{
		...
		{		
			if (vspaisValidCfgStr(sipinterface['vspa_thehomedomain'],getValue('HomeDomain'),256) == false)
			{
				AlertEx(sipinterface['vspa_domainvalid']);
				return false;
			}
...
{    
     ...
     {
         if (vspaisValidCfgStr(sipinterface['vspa_theuri'],getValue('URI'),389) == false)
         {
             return false;
         }    
     }
...
<li id="HomeDomain" RealType="TextBox" DescRef="vspa_homedomain" RemarkRef="vspa_outbandproxyhint" ErrorMsgRef="Empty" Require="FALSE" BindField="HomeDomain" InitValue="Empty" MaxLength="256"/>
