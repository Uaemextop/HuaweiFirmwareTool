...
<script type="text/javascript">
    ...
    {
        document.write("<td>" + CodecList[vagIndex][0].Codecs + "</td>" );
    }
    else
    {
    ...
    {
        document.write("<td>" + CodecList[vagIndex][1].Codecs + "</td>" );
    }
    else
    {
        document.write("<td>" + '-- '+ "</td>" );    
    ...
    {
        document.write("<td>" + CodecList[vagIndex][2].Codecs + "</td>" );
    }
    else
    {
        document.write("<td>" + '-- '+ "</td>" );    
    ...
    {
        document.write("<td>" + CodecList[vagIndex][3].Codecs + "</td>" );
    }
    else
    {
        document.write("<td>" + '-- '+ "</td>" );    
