...
﻿var UsbHostLgeDes =
{
	...
	s0503:    "Exceeded the length limit of the user name (20 characters).",
	...
	s0539:    "On this page, you can configure the FTP client for file downloading from to a storage device of the home gateway, and configure the FTP server for resource sharing. <br> When configuring the FTP server, enable the LAN-side or WAN-side FTP function and select character code in UTF-8 format.",
