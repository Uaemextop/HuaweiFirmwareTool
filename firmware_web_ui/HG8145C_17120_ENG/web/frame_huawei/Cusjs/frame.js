...
var Frame = {
	...
	setCopyRightInfo : function(language) {
        if (language == "english") {
            $("#footerText").html("Copyright © Huawei Technologies Co., Ltd. ##.COPY_RIGHT_YEAR.##. All rights reserved. ");
        }else if (language == "portuguese") {
            $("#footerText").html("Copyright © Huawei Technologies Co., Ltd ##.COPY_RIGHT_YEAR.##. Todos os direitos reservados. ");
        }else if (language == "japanese") {
            $("#footerText").html("Copyright © Huawei Technologies Co., Ltd. ##.COPY_RIGHT_YEAR.##. All rights reserved. ");
        }else if (language == "spanish") {
            $("#footerText").html("Copyright © Huawei Technologies Co., Ltd. ##.COPY_RIGHT_YEAR.##. Todos los derechos reservados. ");
        }
    },
