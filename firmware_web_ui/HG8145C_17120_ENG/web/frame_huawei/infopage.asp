...
function ParseSystemTime(SystemTime)
{
	...
	document.getElementById('td14_2').innerHTML = SystemTime;
}
...
<div style="padding-left:20px; float:left;"><button id="canclebutton" class="CancleButtonCss info_100px" onclick="CancleLogin();" value="Cancle">Cancle</button></div>
</div>
</div>
